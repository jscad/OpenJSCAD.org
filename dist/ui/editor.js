...
exports.putSourceInEditor = putSourceInEditor;
exports.getSourceFromEditor = getSourceFromEditor;
...
require('brace/mode/javascript'); // ui-editor.js
//
...
function setUpEditor(divname, gProcessor) {
  ...
  gEditor = _brace2.default.edit(divname);
