...
function deepMerge(dst, patch) {
  for (var key in patch) {
    ...
    if (patch[key] !== undefined && patch[key].constructor && patch[key].constructor === String && dst[key] !== undefined && dst[key].constructor && dst[key].constructor === Object && 'r' in dst[key] && 'g' in dst[key] && 'b' in dst[key]) {
      dst[key] = (0, _jscadViewerHelpers.colorRGBA)((0, _jscadViewerHelpers.parseColor)(patch[key]));
 ...
 */
function Viewer(containerelement, customization) {
