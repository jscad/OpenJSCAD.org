...
#define LOW_PRECISION`),e}function Kf(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Pr?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===jo?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===bi&&(e="SHADOWMAP_TYPE_VSM"),e}function Jf(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case ai:case Ti:e="ENVMAP_TYPE_CUBE";break;case si:case lr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Qf(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Ti:case lr:e="ENVMAP_MODE_REFRACTION";break}return e}function $f(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Fi:e="ENVMAP_BLENDING_MULTIPLY";break;case la:e="ENVMAP_BLENDING_MIX";break;case ca:e="ENVMAP_BLENDING_ADD";break}return e}function Yu(r,e,t,i){let n=r.getContext(),o=t.defines,a=t.vertexShader,s=t.fragmentShader,c=Kf(t),l=Jf(t),f=Qf(t),d=$f(t),h=r.gammaFactor>0?r.gammaFactor:1,m=t.isWebGL2?"":Vf(t),g=kf(o),x=n.createProgram(),v,u,p=t.glslVersion?"#version "+t.glslVersion+`
