...
const mat4=require("gl-mat4"),{meshColor:meshColor}=require("../../renderDefaults"),drawLines=(e,r={})=>{const o={color:meshColor,geometry:void 0};let{geometry:t,color:s}=Object.assign({},o,r);"color"in t&&(s=t.color);const a=!!(t.indices&&t.indices.length>0),l=!!(t.normals&&t.normals.length>0),i=!!(t.colors&&t.colors.length>0),n={primitive:"lines",vert:i?require("./vColorShaders").vert:require("./meshShaders").vert,frag:i?require("./vColorShaders").frag:require("./colorOnlyShaders").frag,uniforms:{model:(e,r)=>r.model||t.transforms||mat4.create(),ucolor:(e,r)=>r&&r.color?r.color:s},attributes:{position:e.buffer({usage:"static",type:"float",data:t.positions})},blend:{enable:!0,func:{srcRGB:"src alpha",srcAlpha:"src alpha",dstRGB:"one minus src alpha",dstAlpha:"one minus src alpha"}},depth:{enable:!0}};return i&&(n.attributes.color=e.buffer({usage:"static",type:"float",data:t.colors})),a&&(n.elements=e.elements({usage:"static",type:"uint16",data:t.indices})),l&&(n.attributes.normal=e.buffer({usage:"static",type:"float",data:t.normals})),e(n)};module.exports=drawLines;
