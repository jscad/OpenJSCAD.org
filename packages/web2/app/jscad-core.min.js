...
},{"./serializeSolids":41,"@jscad/array-utils":501,"@jscad/modeling":205,"@jscad/vtree":553}],38:[function(require,module,exports){
...
},{"../code-loading/requireDesignFromModule":48,"../code-loading/webRequire":53,"../parameters/getParameterDefinitionsAndValues":58,"@jscad/array-utils":501,"path":10}],40:[function(require,module,exports){
...
},{"@jscad/array-utils":501,"path":10}],50:[function(require,module,exports){
...
},{"@jscad/vtree":553}],53:[function(require,module,exports){
...
},{"../utils/getFileExtensionFromString":62,"./makeFakeFs":45,"./vtreeApi":52,"@jscad/array-utils":501,"@jscad/io":96,"@jscad/modeling":205,"path":10,"strip-bom":33}],54:[function(require,module,exports){
...
},{"../utils/getFileExtensionFromString":62,"@jscad/array-utils":501,"@jscad/io/formats":95,"path":10}],67:[function(require,module,exports){
...
const{maths:maths,geometries:geometries}=require("@jscad/modeling");let lastmaterial;const findMaterial=(e,t)=>{if(lastmaterial&&lastmaterial.id===t)return lastmaterial;for(let o=0;o<e.length;o++)if(e[o].id&&e[o].id===t)return lastmaterial=e[o];return null},getValue=(e,t)=>{for(let o=0;o<e.length;o++)if(e[o].type===t)return e[o].value;return null},getColor=e=>{for(let t=0;t<e.length;t++){const o=e[t];if("color"===o.type){let e=parseFloat(getValue(o.objects,"r")),t=parseFloat(getValue(o.objects,"g")),s=parseFloat(getValue(o.objects,"b")),a=parseFloat(getValue(o.objects,"a"));return Number.isNaN(e)&&(e=1),Number.isNaN(t)&&(t=1),Number.isNaN(s)&&(s=1),Number.isNaN(a)&&(a=1),[e,t,s,a]}}return null},findColorByMaterial=(e,t)=>{const o=findMaterial(e,t);return o?getColor(o.objects):null},createObject=(e,t,o,s)=>{const a=[],l=[],r=[],n=o.amfMaterials,c=(e,t)=>{if("coordinates"===e.type){const t=parseFloat(getValue(e.objects,"x")),o=parseFloat(getValue(e.objects,"y")),s=parseFloat(getValue(e.objects,"z"));a.push([t,o,s])}},i=(e,t)=>{"vertex"===e.type&&e.objects.forEach(c)},g=(e,t)=>{if("triangle"===e.type){const t=parseInt(getValue(e.objects,"v1")),o=parseInt(getValue(e.objects,"v2")),s=parseInt(getValue(e.objects,"v3"));l.push([t,o,s]);const a=getColor(e.objects);a?r.push(a):r.push(u)}};let u=null;const p=(e,t)=>{switch(e.type){case"vertices":e.objects.forEach(i);break;case"volume":u=getColor(e.objects),e.materialid&&(u=findColorByMaterial(n,e.materialid)),e.objects.forEach(g)}},h=(e,t)=>{"mesh"===e.type&&e.objects.forEach(p)};if(!0===s.instantiate){const t=s.amf.scale,o=1!==t?([e,o,s])=>maths.vec3.fromValues(e*t,o*t,s*t):e=>maths.vec3.clone(e);e.objects.forEach(h);const n=l.length,c=a.length,i=[];for(let e=0;e<n;e++){const t=[];for(let s=0;s<l[e].length;s++)l[e][s]<0||l[e][s]>=c||t.push(o(a[l[e][s]]));const s=geometries.poly3.fromPoints(t),n=r[e]?r[e]:void 0;n&&(s.color=n),i.push(s)}return geometries.geom3.create(i)}let m="";if(e.objects.length>0){e.objects.forEach(h);const t=l.length,o=a.length;m+=`\n// Object ${e.id}\n//  faces   : ${t}\n//  vertices: ${o}\nconst createObject${e.id} = () => {\n  let polygons = []\n  let polygon\n`;for(let e=0;e<t;e++){m+="  polygon = geometries.poly3.fromPoints([\n";for(let t=0;t<l[e].length;t++)l[e][t]<0||l[e][t]>=o||(m+=`      [${a[l[e][t]]}],\n`);m+="  ])\n";const t=r[e];t&&(m+=`  polygon.color = [${t}]\n`),m+="  polygons.push(polygon)\n"}m+="  let shape = geometries.geom3.create(polygons)\n";const n=s.scale?s.scale:1;1!==n&&(m+=`  shape = transforms.scale([${n},${n},${n}], shape)\n`),m+="  return shape\n}\n"}return m};module.exports=createObject;
...
},{"@jscad/array-utils":501,"@jscad/modeling":205,"onml/lib/stringify":77}],77:[function(require,module,exports){
...
},{"./autocad_AC2017":86,"./colorindex2017":87,"@jscad/array-utils":501,"@jscad/modeling":205}],89:[function(require,module,exports){
...
},{"./formats":95,"@jscad/amf-serializer":76,"@jscad/array-utils":501,"@jscad/dxf-serializer":88,"@jscad/json-serializer":100,"@jscad/stl-serializer":107,"@jscad/svg-serializer":116,"@jscad/x3d-serializer":119}],98:[function(require,module,exports){
...
},{"./package.json":99,"@jscad/array-utils":501}],99:[function(require,module,exports){
module.exports={
...
},{"./CSGToStla":105,"./CSGToStlb":106,"@jscad/array-utils":501,"@jscad/modeling":205}],108:[function(require,module,exports){
...
},{"./constants":108,"./helpers":109,"./package.json":112,"./shapesMapGeometry":113,"./shapesMapJscad":114,"./svgElementHelpers":115,"@jscad/array-utils":501,"@jscad/modeling":205,"sax":111}],111:[function(require,module,exports){
(function (Buffer){(function (){
!function(t){t.parser=function(t,e){return new s(t,e)},t.SAXParser=s,t.SAXStream=n,t.createStream=function(t,e){return new n(t,e)},t.MAX_BUFFER_LENGTH=65536;var e,i=["comment","sgmlDecl","textNode","tagName","doctype","procInstName","procInstBody","entity","attribName","attribValue","cdata","script"];function s(e,a){if(!(this instanceof s))return new s(e,a);!function(t){for(var e=0,s=i.length;e<s;e++)t[i[e]]=""}(this),this.q=this.c="",this.bufferCheckPosition=t.MAX_BUFFER_LENGTH,this.opt=a||{},this.opt.lowercase=this.opt.lowercase||this.opt.lowercasetags,this.looseCase=this.opt.lowercase?"toLowerCase":"toUpperCase",this.tags=[],this.closed=this.closedRoot=this.sawRoot=!1,this.tag=this.error=null,this.strict=!!e,this.noscript=!(!e&&!this.opt.noscript),this.state=D.BEGIN,this.strictEntities=this.opt.strictEntities,this.ENTITIES=this.strictEntities?Object.create(t.XML_ENTITIES):Object.create(t.ENTITIES),this.attribList=[],this.opt.xmlns&&(this.ns=Object.create(h)),this.trackPosition=!1!==this.opt.position,this.trackPosition&&(this.position=this.line=this.column=0),C(this,"onready")}t.EVENTS=["text","processinginstruction","sgmldeclaration","doctype","comment","opentagstart","attribute","opentag","closetag","opencdata","cdata","closecdata","error","end","ready","script","opennamespace","closenamespace"],Object.create||(Object.create=function(t){function e(){}return e.prototype=t,new e}),Object.keys||(Object.keys=function(t){var e=[];for(var i in t)t.hasOwnProperty(i)&&e.push(i);return e}),s.prototype={end:function(){v(this)},write:function(e){if(this.error)throw this.error;if(this.closed)return R(this,"Cannot write after close. Assign an onready handler.");if(null===e)return v(this);"object"==typeof e&&(e=e.toString());var s=0,a="";for(;a=M(e,s++),this.c=a,a;)switch(this.trackPosition&&(this.position++,"\n"===a?(this.line++,this.column=0):this.column++),this.state){case D.BEGIN:if(this.state=D.BEGIN_WHITESPACE,"\ufeff"===a)continue;G(this,a);continue;case D.BEGIN_WHITESPACE:G(this,a);continue;case D.TEXT:if(this.sawRoot&&!this.closedRoot){for(var n=s-1;a&&"<"!==a&&"&"!==a;)(a=M(e,s++))&&this.trackPosition&&(this.position++,"\n"===a?(this.line++,this.column=0):this.column++);this.textNode+=e.substring(n,s-1)}"<"!==a||this.sawRoot&&this.closedRoot&&!this.strict?(m(a)||this.sawRoot&&!this.closedRoot||P(this,"Text data outside of root node."),"&"===a?this.state=D.TEXT_ENTITY:this.textNode+=a):(this.state=D.OPEN_WAKA,this.startTagPosition=this.position);continue;case D.SCRIPT:"<"===a?this.state=D.SCRIPT_ENDING:this.script+=a;continue;case D.SCRIPT_ENDING:"/"===a?this.state=D.CLOSE_TAG:(this.script+="<"+a,this.state=D.SCRIPT);continue;case D.OPEN_WAKA:if("!"===a)this.state=D.SGML_DECL,this.sgmlDecl="";else if(m(a));else if(_(l,a))this.state=D.OPEN_TAG,this.tagName=a;else if("/"===a)this.state=D.CLOSE_TAG,this.tagName="";else if("?"===a)this.state=D.PROC_INST,this.procInstName=this.procInstBody="";else{if(P(this,"Unencoded <"),this.startTagPosition+1<this.position){var c=this.position-this.startTagPosition;a=new Array(c).join(" ")+a}this.textNode+="<"+a,this.state=D.TEXT}continue;case D.SGML_DECL:(this.sgmlDecl+a).toUpperCase()===r?(O(this,"onopencdata"),this.state=D.CDATA,this.sgmlDecl="",this.cdata=""):this.sgmlDecl+a==="--"?(this.state=D.COMMENT,this.comment="",this.sgmlDecl=""):(this.sgmlDecl+a).toUpperCase()===o?(this.state=D.DOCTYPE,(this.doctype||this.sawRoot)&&P(this,"Inappropriately located doctype declaration"),this.doctype="",this.sgmlDecl=""):">"===a?(O(this,"onsgmldeclaration",this.sgmlDecl),this.sgmlDecl="",this.state=D.TEXT):N(a)?(this.state=D.SGML_DECL_QUOTED,this.sgmlDecl+=a):this.sgmlDecl+=a;continue;case D.SGML_DECL_QUOTED:a===this.q&&(this.state=D.SGML_DECL,this.q=""),this.sgmlDecl+=a;continue;case D.DOCTYPE:">"===a?(this.state=D.TEXT,O(this,"ondoctype",this.doctype),this.doctype=!0):(this.doctype+=a,"["===a?this.state=D.DOCTYPE_DTD:N(a)&&(this.state=D.DOCTYPE_QUOTED,this.q=a));continue;case D.DOCTYPE_QUOTED:this.doctype+=a,a===this.q&&(this.q="",this.state=D.DOCTYPE);continue;case D.DOCTYPE_DTD:this.doctype+=a,"]"===a?this.state=D.DOCTYPE:N(a)&&(this.state=D.DOCTYPE_DTD_QUOTED,this.q=a);continue;case D.DOCTYPE_DTD_QUOTED:this.doctype+=a,a===this.q&&(this.state=D.DOCTYPE_DTD,this.q="");continue;case D.COMMENT:"-"===a?this.state=D.COMMENT_ENDING:this.comment+=a;continue;case D.COMMENT_ENDING:"-"===a?(this.state=D.COMMENT_ENDED,this.comment=S(this.opt,this.comment),this.comment&&O(this,"oncomment",this.comment),this.comment=""):(this.comment+="-"+a,this.state=D.COMMENT);continue;case D.COMMENT_ENDED:">"!==a?(P(this,"Malformed comment"),this.comment+="--"+a,this.state=D.COMMENT):this.state=D.TEXT;continue;case D.CDATA:"]"===a?this.state=D.CDATA_ENDING:this.cdata+=a;continue;case D.CDATA_ENDING:"]"===a?this.state=D.CDATA_ENDING_2:(this.cdata+="]"+a,this.state=D.CDATA);continue;case D.CDATA_ENDING_2:">"===a?(this.cdata&&O(this,"oncdata",this.cdata),O(this,"onclosecdata"),this.cdata="",this.state=D.TEXT):"]"===a?this.cdata+="]":(this.cdata+="]]"+a,this.state=D.CDATA);continue;case D.PROC_INST:"?"===a?this.state=D.PROC_INST_ENDING:m(a)?this.state=D.PROC_INST_BODY:this.procInstName+=a;continue;case D.PROC_INST_BODY:if(!this.procInstBody&&m(a))continue;"?"===a?this.state=D.PROC_INST_ENDING:this.procInstBody+=a;continue;case D.PROC_INST_ENDING:">"===a?(O(this,"onprocessinginstruction",{name:this.procInstName,body:this.procInstBody}),this.procInstName=this.procInstBody="",this.state=D.TEXT):(this.procInstBody+="?"+a,this.state=D.PROC_INST_BODY);continue;case D.OPEN_TAG:_(T,a)?this.tagName+=a:(y(this),">"===a?U(this):"/"===a?this.state=D.OPEN_TAG_SLASH:(m(a)||P(this,"Invalid character in tag name"),this.state=D.ATTRIB));continue;case D.OPEN_TAG_SLASH:">"===a?(U(this,!0),x(this)):(P(this,"Forward-slash in opening tag not followed by >"),this.state=D.ATTRIB);continue;case D.ATTRIB:if(m(a))continue;">"===a?U(this):"/"===a?this.state=D.OPEN_TAG_SLASH:_(l,a)?(this.attribName=a,this.attribValue="",this.state=D.ATTRIB_NAME):P(this,"Invalid attribute name");continue;case D.ATTRIB_NAME:"="===a?this.state=D.ATTRIB_VALUE:">"===a?(P(this,"Attribute without value"),this.attribValue=this.attribName,B(this),U(this)):m(a)?this.state=D.ATTRIB_NAME_SAW_WHITE:_(T,a)?this.attribName+=a:P(this,"Invalid attribute name");continue;case D.ATTRIB_NAME_SAW_WHITE:if("="===a)this.state=D.ATTRIB_VALUE;else{if(m(a))continue;P(this,"Attribute without value"),this.tag.attributes[this.attribName]="",this.attribValue="",O(this,"onattribute",{name:this.attribName,value:""}),this.attribName="",">"===a?U(this):_(l,a)?(this.attribName=a,this.state=D.ATTRIB_NAME):(P(this,"Invalid attribute name"),this.state=D.ATTRIB)}continue;case D.ATTRIB_VALUE:if(m(a))continue;N(a)?(this.q=a,this.state=D.ATTRIB_VALUE_QUOTED):(P(this,"Unquoted attribute value"),this.state=D.ATTRIB_VALUE_UNQUOTED,this.attribValue=a);continue;case D.ATTRIB_VALUE_QUOTED:if(a!==this.q){"&"===a?this.state=D.ATTRIB_VALUE_ENTITY_Q:this.attribValue+=a;continue}B(this),this.q="",this.state=D.ATTRIB_VALUE_CLOSED;continue;case D.ATTRIB_VALUE_CLOSED:m(a)?this.state=D.ATTRIB:">"===a?U(this):"/"===a?this.state=D.OPEN_TAG_SLASH:_(l,a)?(P(this,"No whitespace between attributes"),this.attribName=a,this.attribValue="",this.state=D.ATTRIB_NAME):P(this,"Invalid attribute name");continue;case D.ATTRIB_VALUE_UNQUOTED:if(!f(a)){"&"===a?this.state=D.ATTRIB_VALUE_ENTITY_U:this.attribValue+=a;continue}B(this),">"===a?U(this):this.state=D.ATTRIB;continue;case D.CLOSE_TAG:if(this.tagName)">"===a?x(this):_(T,a)?this.tagName+=a:this.script?(this.script+="</"+this.tagName,this.tagName="",this.state=D.SCRIPT):(m(a)||P(this,"Invalid tagname in closing tag"),this.state=D.CLOSE_TAG_SAW_WHITE);else{if(m(a))continue;d(l,a)?this.script?(this.script+="</"+a,this.state=D.SCRIPT):P(this,"Invalid tagname in closing tag."):this.tagName=a}continue;case D.CLOSE_TAG_SAW_WHITE:if(m(a))continue;">"===a?x(this):P(this,"Invalid characters in closing tag");continue;case D.TEXT_ENTITY:case D.ATTRIB_VALUE_ENTITY_Q:case D.ATTRIB_VALUE_ENTITY_U:var u,h;switch(this.state){case D.TEXT_ENTITY:u=D.TEXT,h="textNode";break;case D.ATTRIB_VALUE_ENTITY_Q:u=D.ATTRIB_VALUE_QUOTED,h="attribValue";break;case D.ATTRIB_VALUE_ENTITY_U:u=D.ATTRIB_VALUE_UNQUOTED,h="attribValue"}";"===a?(this[h]+=w(this),this.entity="",this.state=u):_(this.entity.length?p:E,a)?this.entity+=a:(P(this,"Invalid character in entity name"),this[h]+="&"+this.entity+a,this.entity="",this.state=u);continue;default:throw new Error(this,"Unknown state: "+this.state)}this.position>=this.bufferCheckPosition&&function(e){for(var s=Math.max(t.MAX_BUFFER_LENGTH,10),a=0,n=0,r=i.length;n<r;n++){var o=e[i[n]].length;if(o>s)switch(i[n]){case"textNode":F(e);break;case"cdata":O(e,"oncdata",e.cdata),e.cdata="";break;case"script":O(e,"onscript",e.script),e.script="";break;default:R(e,"Max buffer length exceeded: "+i[n])}a=Math.max(a,o)}var c=t.MAX_BUFFER_LENGTH-a;e.bufferCheckPosition=c+e.position}(this);return this},resume:function(){return this.error=null,this},close:function(){return this.write(null)},flush:function(){var t;F(t=this),""!==t.cdata&&(O(t,"oncdata",t.cdata),t.cdata=""),""!==t.script&&(O(t,"onscript",t.script),t.script="")}};try{e=require("stream").Stream}catch(t){e=function(){}}var a=t.EVENTS.filter(function(t){return"error"!==t&&"end"!==t});function n(t,i){if(!(this instanceof n))return new n(t,i);e.apply(this),this._parser=new s(t,i),this.writable=!0,this.readable=!0;var r=this;this._parser.onend=function(){r.emit("end")},this._parser.onerror=function(t){r.emit("error",t),r._parser.error=null},this._decoder=null,a.forEach(function(t){Object.defineProperty(r,"on"+t,{get:function(){return r._parser["on"+t]},set:function(e){if(!e)return r.removeAllListeners(t),r._parser["on"+t]=e,e;r.on(t,e)},enumerable:!0,configurable:!1})})}n.prototype=Object.create(e.prototype,{constructor:{value:n}}),n.prototype.write=function(t){if("function"==typeof Buffer&&"function"==typeof Buffer.isBuffer&&Buffer.isBuffer(t)){if(!this._decoder){var e=require("string_decoder").StringDecoder;this._decoder=new e("utf8")}t=this._decoder.write(t)}return this._parser.write(t.toString()),this.emit("data",t),!0},n.prototype.end=function(t){return t&&t.length&&this.write(t),this._parser.end(),!0},n.prototype.on=function(t,i){var s=this;return s._parser["on"+t]||-1===a.indexOf(t)||(s._parser["on"+t]=function(){var e=1===arguments.length?[arguments[0]]:Array.apply(null,arguments);e.splice(0,0,t),s.emit.apply(s,e)}),e.prototype.on.call(s,t,i)};var r="[CDATA[",o="DOCTYPE",c="http://www.w3.org/XML/1998/namespace",u="http://www.w3.org/2000/xmlns/",h={xml:c,xmlns:u},l=/[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/,T=/[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/,E=/[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/,p=/[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;function m(t){return" "===t||"\n"===t||"\r"===t||"\t"===t}function N(t){return'"'===t||"'"===t}function f(t){return">"===t||m(t)}function _(t,e){return t.test(e)}function d(t,e){return!_(t,e)}var g,A,I,D=0;for(var b in t.STATE={BEGIN:D++,BEGIN_WHITESPACE:D++,TEXT:D++,TEXT_ENTITY:D++,OPEN_WAKA:D++,SGML_DECL:D++,SGML_DECL_QUOTED:D++,DOCTYPE:D++,DOCTYPE_QUOTED:D++,DOCTYPE_DTD:D++,DOCTYPE_DTD_QUOTED:D++,COMMENT_STARTING:D++,COMMENT:D++,COMMENT_ENDING:D++,COMMENT_ENDED:D++,CDATA:D++,CDATA_ENDING:D++,CDATA_ENDING_2:D++,PROC_INST:D++,PROC_INST_BODY:D++,PROC_INST_ENDING:D++,OPEN_TAG:D++,OPEN_TAG_SLASH:D++,ATTRIB:D++,ATTRIB_NAME:D++,ATTRIB_NAME_SAW_WHITE:D++,ATTRIB_VALUE:D++,ATTRIB_VALUE_QUOTED:D++,ATTRIB_VALUE_CLOSED:D++,ATTRIB_VALUE_UNQUOTED:D++,ATTRIB_VALUE_ENTITY_Q:D++,ATTRIB_VALUE_ENTITY_U:D++,CLOSE_TAG:D++,CLOSE_TAG_SAW_WHITE:D++,SCRIPT:D++,SCRIPT_ENDING:D++},t.XML_ENTITIES={amp:"&",gt:">",lt:"<",quot:'"',apos:"'"},t.ENTITIES={amp:"&",gt:">",lt:"<",quot:'"',apos:"'",AElig:198,Aacute:193,Acirc:194,Agrave:192,Aring:197,Atilde:195,Auml:196,Ccedil:199,ETH:208,Eacute:201,Ecirc:202,Egrave:200,Euml:203,Iacute:205,Icirc:206,Igrave:204,Iuml:207,Ntilde:209,Oacute:211,Ocirc:212,Ograve:210,Oslash:216,Otilde:213,Ouml:214,THORN:222,Uacute:218,Ucirc:219,Ugrave:217,Uuml:220,Yacute:221,aacute:225,acirc:226,aelig:230,agrave:224,aring:229,atilde:227,auml:228,ccedil:231,eacute:233,ecirc:234,egrave:232,eth:240,euml:235,iacute:237,icirc:238,igrave:236,iuml:239,ntilde:241,oacute:243,ocirc:244,ograve:242,oslash:248,otilde:245,ouml:246,szlig:223,thorn:254,uacute:250,ucirc:251,ugrave:249,uuml:252,yacute:253,yuml:255,copy:169,reg:174,nbsp:160,iexcl:161,cent:162,pound:163,curren:164,yen:165,brvbar:166,sect:167,uml:168,ordf:170,laquo:171,not:172,shy:173,macr:175,deg:176,plusmn:177,sup1:185,sup2:178,sup3:179,acute:180,micro:181,para:182,middot:183,cedil:184,ordm:186,raquo:187,frac14:188,frac12:189,frac34:190,iquest:191,times:215,divide:247,OElig:338,oelig:339,Scaron:352,scaron:353,Yuml:376,fnof:402,circ:710,tilde:732,Alpha:913,Beta:914,Gamma:915,Delta:916,Epsilon:917,Zeta:918,Eta:919,Theta:920,Iota:921,Kappa:922,Lambda:923,Mu:924,Nu:925,Xi:926,Omicron:927,Pi:928,Rho:929,Sigma:931,Tau:932,Upsilon:933,Phi:934,Chi:935,Psi:936,Omega:937,alpha:945,beta:946,gamma:947,delta:948,epsilon:949,zeta:950,eta:951,theta:952,iota:953,kappa:954,lambda:955,mu:956,nu:957,xi:958,omicron:959,pi:960,rho:961,sigmaf:962,sigma:963,tau:964,upsilon:965,phi:966,chi:967,psi:968,omega:969,thetasym:977,upsih:978,piv:982,ensp:8194,emsp:8195,thinsp:8201,zwnj:8204,zwj:8205,lrm:8206,rlm:8207,ndash:8211,mdash:8212,lsquo:8216,rsquo:8217,sbquo:8218,ldquo:8220,rdquo:8221,bdquo:8222,dagger:8224,Dagger:8225,bull:8226,hellip:8230,permil:8240,prime:8242,Prime:8243,lsaquo:8249,rsaquo:8250,oline:8254,frasl:8260,euro:8364,image:8465,weierp:8472,real:8476,trade:8482,alefsym:8501,larr:8592,uarr:8593,rarr:8594,darr:8595,harr:8596,crarr:8629,lArr:8656,uArr:8657,rArr:8658,dArr:8659,hArr:8660,forall:8704,part:8706,exist:8707,empty:8709,nabla:8711,isin:8712,notin:8713,ni:8715,prod:8719,sum:8721,minus:8722,lowast:8727,radic:8730,prop:8733,infin:8734,ang:8736,and:8743,or:8744,cap:8745,cup:8746,int:8747,there4:8756,sim:8764,cong:8773,asymp:8776,ne:8800,equiv:8801,le:8804,ge:8805,sub:8834,sup:8835,nsub:8836,sube:8838,supe:8839,oplus:8853,otimes:8855,perp:8869,sdot:8901,lceil:8968,rceil:8969,lfloor:8970,rfloor:8971,lang:9001,rang:9002,loz:9674,spades:9824,clubs:9827,hearts:9829,diams:9830},Object.keys(t.ENTITIES).forEach(function(e){var i=t.ENTITIES[e],s="number"==typeof i?String.fromCharCode(i):i;t.ENTITIES[e]=s}),t.STATE)t.STATE[t.STATE[b]]=b;function C(t,e,i){t[e]&&t[e](i)}function O(t,e,i){t.textNode&&F(t),C(t,e,i)}function F(t){t.textNode=S(t.opt,t.textNode),t.textNode&&C(t,"ontext",t.textNode),t.textNode=""}function S(t,e){return t.trim&&(e=e.trim()),t.normalize&&(e=e.replace(/\s+/g," ")),e}function R(t,e){return F(t),t.trackPosition&&(e+="\nLine: "+t.line+"\nColumn: "+t.column+"\nChar: "+t.c),e=new Error(e),t.error=e,C(t,"onerror",e),t}function v(t){return t.sawRoot&&!t.closedRoot&&P(t,"Unclosed root tag"),t.state!==D.BEGIN&&t.state!==D.BEGIN_WHITESPACE&&t.state!==D.TEXT&&R(t,"Unexpected end"),F(t),t.c="",t.closed=!0,C(t,"onend"),s.call(t,t.strict,t.opt),t}function P(t,e){if("object"!=typeof t||!(t instanceof s))throw new Error("bad call to strictFail");t.strict&&R(t,e)}function y(t){t.strict||(t.tagName=t.tagName[t.looseCase]());var e=t.tags[t.tags.length-1]||t,i=t.tag={name:t.tagName,attributes:{}};t.opt.xmlns&&(i.ns=e.ns),t.attribList.length=0,O(t,"onopentagstart",i)}function L(t,e){var i=t.indexOf(":")<0?["",t]:t.split(":"),s=i[0],a=i[1];return e&&"xmlns"===t&&(s="xmlns",a=""),{prefix:s,local:a}}function B(t){if(t.strict||(t.attribName=t.attribName[t.looseCase]()),-1!==t.attribList.indexOf(t.attribName)||t.tag.attributes.hasOwnProperty(t.attribName))t.attribName=t.attribValue="";else{if(t.opt.xmlns){var e=L(t.attribName,!0),i=e.prefix,s=e.local;if("xmlns"===i)if("xml"===s&&t.attribValue!==c)P(t,"xml: prefix must be bound to "+c+"\nActual: "+t.attribValue);else if("xmlns"===s&&t.attribValue!==u)P(t,"xmlns: prefix must be bound to "+u+"\nActual: "+t.attribValue);else{var a=t.tag,n=t.tags[t.tags.length-1]||t;a.ns===n.ns&&(a.ns=Object.create(n.ns)),a.ns[s]=t.attribValue}t.attribList.push([t.attribName,t.attribValue])}else t.tag.attributes[t.attribName]=t.attribValue,O(t,"onattribute",{name:t.attribName,value:t.attribValue});t.attribName=t.attribValue=""}}function U(t,e){if(t.opt.xmlns){var i=t.tag,s=L(t.tagName);i.prefix=s.prefix,i.local=s.local,i.uri=i.ns[s.prefix]||"",i.prefix&&!i.uri&&(P(t,"Unbound namespace prefix: "+JSON.stringify(t.tagName)),i.uri=s.prefix);var a=t.tags[t.tags.length-1]||t;i.ns&&a.ns!==i.ns&&Object.keys(i.ns).forEach(function(e){O(t,"onopennamespace",{prefix:e,uri:i.ns[e]})});for(var n=0,r=t.attribList.length;n<r;n++){var o=t.attribList[n],c=o[0],u=o[1],h=L(c,!0),l=h.prefix,T=h.local,E=""===l?"":i.ns[l]||"",p={name:c,value:u,prefix:l,local:T,uri:E};l&&"xmlns"!==l&&!E&&(P(t,"Unbound namespace prefix: "+JSON.stringify(l)),p.uri=l),t.tag.attributes[c]=p,O(t,"onattribute",p)}t.attribList.length=0}t.tag.isSelfClosing=!!e,t.sawRoot=!0,t.tags.push(t.tag),O(t,"onopentag",t.tag),e||(t.noscript||"script"!==t.tagName.toLowerCase()?t.state=D.TEXT:t.state=D.SCRIPT,t.tag=null,t.tagName=""),t.attribName=t.attribValue="",t.attribList.length=0}function x(t){if(!t.tagName)return P(t,"Weird empty close tag."),t.textNode+="</>",void(t.state=D.TEXT);if(t.script){if("script"!==t.tagName)return t.script+="</"+t.tagName+">",t.tagName="",void(t.state=D.SCRIPT);O(t,"onscript",t.script),t.script=""}var e=t.tags.length,i=t.tagName;t.strict||(i=i[t.looseCase]());for(var s=i;e--;){if(t.tags[e].name===s)break;P(t,"Unexpected close tag")}if(e<0)return P(t,"Unmatched closing tag: "+t.tagName),t.textNode+="</"+t.tagName+">",void(t.state=D.TEXT);t.tagName=i;for(var a=t.tags.length;a-- >e;){var n=t.tag=t.tags.pop();t.tagName=t.tag.name,O(t,"onclosetag",t.tagName);var r={};for(var o in n.ns)r[o]=n.ns[o];var c=t.tags[t.tags.length-1]||t;t.opt.xmlns&&n.ns!==c.ns&&Object.keys(n.ns).forEach(function(e){var i=n.ns[e];O(t,"onclosenamespace",{prefix:e,uri:i})})}0===e&&(t.closedRoot=!0),t.tagName=t.attribValue=t.attribName="",t.attribList.length=0,t.state=D.TEXT}function w(t){var e,i=t.entity,s=i.toLowerCase(),a="";return t.ENTITIES[i]?t.ENTITIES[i]:t.ENTITIES[s]?t.ENTITIES[s]:("#"===(i=s).charAt(0)&&("x"===i.charAt(1)?(i=i.slice(2),a=(e=parseInt(i,16)).toString(16)):(i=i.slice(1),a=(e=parseInt(i,10)).toString(10))),i=i.replace(/^0+/,""),isNaN(e)||a.toLowerCase()!==i?(P(t,"Invalid character entity"),"&"+t.entity+";"):String.fromCodePoint(e))}function G(t,e){"<"===e?(t.state=D.OPEN_WAKA,t.startTagPosition=t.position):m(e)||(P(t,"Non-whitespace before first tag."),t.textNode=e,t.state=D.TEXT)}function M(t,e){var i="";return e<t.length&&(i=t.charAt(e)),i}D=t.STATE,String.fromCodePoint||(g=String.fromCharCode,A=Math.floor,I=function(){var t,e,i=[],s=-1,a=arguments.length;if(!a)return"";for(var n="";++s<a;){var r=Number(arguments[s]);if(!isFinite(r)||r<0||r>1114111||A(r)!==r)throw RangeError("Invalid code point: "+r);r<=65535?i.push(r):(t=55296+((r-=65536)>>10),e=r%1024+56320,i.push(t,e)),(s+1===a||i.length>16384)&&(n+=g.apply(null,i),i.length=0)}return n},Object.defineProperty?Object.defineProperty(String,"fromCodePoint",{value:I,configurable:!0,writable:!0}):String.fromCodePoint=I)}("undefined"==typeof exports?this.sax={}:exports);
...
},{"@jscad/array-utils":501,"@jscad/modeling":205,"onml/lib/stringify":120}],120:[function(require,module,exports){
"use strict";function isObject(n){return n&&"[object Object]"===Object.prototype.toString.call(n)}function indenter(n){var t=" ".repeat(n);return function(n){var e,r=[];return"string"!=typeof n?n:1===(e=n.split("\n")).length?t+n:(e.forEach(function(n){""!==n.trim()?r.push(t+n):r.push(n)}),r.join("\n"))}}function clean(n){var t=n.split("\n"),e=[];return t.forEach(function(n){""!==n.trim()&&e.push(n)}),e.join("\n")}function stringify(n,t){var e="",r=function(n){return n};return t>0&&(e="\n",r=indenter(t)),function n(t){var i,o,c;return o="",c=!0,t.some(function(t,r,u){if(0===r)return i="<"+t,1===u.length||void 0;if(1===r){if(isObject(t))return Object.keys(t).forEach(function(n){i+=" "+n+'="'+t[n]+'"'}),2===u.length||void(i+=">");i+=">"}switch(typeof t){case"string":case"number":case"boolean":case"undefined":return void(o+=t+e)}c=!1,o+=n(t)})?i+"/>"+e:c?i+clean(o)+"</"+t[0]+">"+e:i+e+r(o)+"</"+t[0]+">"+e}(n)}module.exports=stringify;
...
},{"../geometries/geom2":142,"../geometries/geom3":156,"../geometries/path2":177,"../geometries/poly3":193,"../utils/flatten":491}],123:[function(require,module,exports){
...
},{"../utils/flatten":491,"./hueToColorComponent":127}],126:[function(require,module,exports){
...
},{"../utils/flatten":491}],127:[function(require,module,exports){
...
},{"../utils/flatten":491}],130:[function(require,module,exports){
...
},{"../utils/flatten":491}],131:[function(require,module,exports){
...
},{"../utils/flatten":491}],132:[function(require,module,exports){
...
const mat4=require("../../maths/mat4"),vec2=require("../../maths/vec2"),applyTransforms=r=>mat4.equals(r.transforms,mat4.create())?r:(r.sides=r.sides.map(e=>{return[vec2.transform(vec2.create(),e[0],r.transforms),vec2.transform(vec2.create(),e[1],r.transforms)]}),mat4.identity(r.transforms),r);module.exports=applyTransforms;

},{"../../maths/mat4":257,"../../maths/vec2":301}],138:[function(require,module,exports){
...
},{"../../maths/mat4":257,"../../maths/vec2":301,"./create":139}],139:[function(require,module,exports){
const mat4=require("../../maths/mat4"),create=e=>(void 0===e&&(e=[]),{sides:e,transforms:mat4.create()});module.exports=create;

},{"../../maths/mat4":257}],140:[function(require,module,exports){
...
},{"../../maths/mat4":257,"../../maths/vec2":301,"./create":139}],141:[function(require,module,exports){
...
},{"../../maths/vec2":301,"./create":139}],142:[function(require,module,exports){
...
},{"../../maths/vec2":301,"./toSides":148}],147:[function(require,module,exports){
...
},{"../../maths/vec2":301,"./toSides":148}],150:[function(require,module,exports){
...
},{"../../maths/mat4":257,"./create":139}],151:[function(require,module,exports){
const mat4=require("../../maths/mat4"),poly3=require("../poly3"),applyTransforms=r=>mat4.equals(r.transforms,mat4.create())?r:(r.polygons=r.polygons.map(a=>poly3.transform(r.transforms,a)),mat4.identity(r.transforms),r);module.exports=applyTransforms;

},{"../../maths/mat4":257,"../poly3":193}],152:[function(require,module,exports){
...
},{"../../maths/mat4":257,"../poly3":193,"./create":153}],153:[function(require,module,exports){
...
},{"../../maths/mat4":257}],154:[function(require,module,exports){
...
},{"../../maths/mat4":257,"../../maths/vec3":332,"../poly3":193,"./create":153}],155:[function(require,module,exports){
...
},{"../../maths/mat4":257,"./create":153}],164:[function(require,module,exports){
...
},{"../../maths/vec2":301,"./fromPoints":176,"./toPoints":181}],166:[function(require,module,exports){
...
},{"../../maths/vec2":301,"./appendPoints":167,"./toPoints":181}],167:[function(require,module,exports){
...
const mat4=require("../../maths/mat4"),vec2=require("../../maths/vec2"),applyTransforms=a=>mat4.equals(a.transforms,mat4.create())?a:(a.points=a.points.map(r=>vec2.transform(vec2.create(),r,a.transforms)),mat4.identity(a.transforms),a);module.exports=applyTransforms;

},{"../../maths/mat4":257,"../../maths/vec2":301}],169:[function(require,module,exports){
...
},{"../../maths/mat4":257,"../../maths/vec2":301,"./create":172}],170:[function(require,module,exports){
...
},{"../../maths/constants":207,"../../maths/vec2":301,"./clone":169}],171:[function(require,module,exports){
...
},{"../../maths/mat4":257}],173:[function(require,module,exports){
...
},{"../../maths/vec2":301,"./toPoints":181}],175:[function(require,module,exports){
...
},{"../../maths/mat4":257,"../../maths/vec2":301,"./create":172}],176:[function(require,module,exports){
...
},{"../../maths/constants":207,"../../maths/vec2":301,"./close":170,"./create":172}],177:[function(require,module,exports){
...
},{"../../maths/vec2":301,"./toPoints":181}],183:[function(require,module,exports){
...
},{"../../maths/mat4":257,"./create":172}],184:[function(require,module,exports){
...
},{"../../maths/utils/area":278}],189:[function(require,module,exports){
...
},{"../../maths/vec3":332,"./create":190}],190:[function(require,module,exports){
const create=e=>((void 0===e||e.length<3)&&(e=[]),{vertices:e});module.exports=create;
...
},{"../../maths/vec3":332,"./create":190}],192:[function(require,module,exports){
...
},{"../../maths/plane":273,"../../maths/vec3":332}],197:[function(require,module,exports){
...
},{"../../maths/vec3":332}],198:[function(require,module,exports){
...
},{"../../maths/vec3":332}],199:[function(require,module,exports){
...
},{"../../maths/vec3":332,"./measureBoundingBox":198}],200:[function(require,module,exports){
...
},{"../../maths/vec3":332}],201:[function(require,module,exports){
...
},{"../../maths/plane/":273}],202:[function(require,module,exports){
...
},{"../../maths/vec3/":332}],204:[function(require,module,exports){
...
},{"../../maths/mat4":257,"../../maths/vec3":332,"./create":190}],205:[function(require,module,exports){
...
},{"./constants":207,"./line2":218,"./line3":235,"./mat4":257,"./plane":273,"./utils":280,"./vec2":301,"./vec3":332,"./vec4":359}],209:[function(require,module,exports){
const create=require("./create"),clone=e=>{const r=create();return r[0]=e[0],r[1]=e[1],r[2]=e[2],r};module.exports=clone;

},{"./create":212}],210:[function(require,module,exports){
...
},{"../vec2":301,"./direction":213,"./origin":220}],211:[function(require,module,exports){
...
},{"./clone":209,"./closestPoint":210,"./copy":211,"./create":212,"./direction":213,"./distanceToPoint":214,"./equals":215,"./fromPoints":216,"./fromValues":217,"./intersectPointOfLines":219,"./origin":220,"./reverse":221,"./toString":222,"./transform":223,"./xAtY":224}],219:[function(require,module,exports){
...
},{"../utils":280,"../vec2":301}],220:[function(require,module,exports){
const vec2=require("../vec2"),origin=e=>vec2.scale(vec2.create(),e,e[2]);module.exports=origin;

},{"../vec2":301}],221:[function(require,module,exports){
...
},{"../vec2":301,"./copy":211,"./fromValues":217}],222:[function(require,module,exports){
...
},{"../vec2":301,"./direction":213,"./fromPoints":216,"./origin":220}],224:[function(require,module,exports){
const origin=require("./origin"),xAtY=(i,r)=>{let e=(i[2]-i[1]*r)/i[0];if(Number.isNaN(e)){e=origin(i)[0]}return e};module.exports=xAtY;

},{"./origin":220}],225:[function(require,module,exports){
...
},{"../vec3":332,"./create":228}],226:[function(require,module,exports){
...
},{"../vec3":332,"./closestPoint":226}],231:[function(require,module,exports){
const vec3=require("../vec3"),equals=(e,s)=>!!vec3.equals(e[1],s[1])&&!!vec3.equals(e[0],s[0]);module.exports=equals;

},{"../vec3":332}],232:[function(require,module,exports){
...
},{"../constants":207,"../utils":280,"../vec3":332,"./fromPointAndDirection":233}],233:[function(require,module,exports){
const vec3=require("../vec3"),fromPointAndDirection=(e,c,o)=>{const n=vec3.unit(vec3.create(),o);return vec3.copy(e[0],c),vec3.copy(e[1],n),e};module.exports=fromPointAndDirection;

},{"../vec3":332}],234:[function(require,module,exports){
...
},{"../vec3":332,"./fromPointAndDirection":233}],235:[function(require,module,exports){
...
},{"./clone":225,"./closestPoint":226,"./copy":227,"./create":228,"./direction":229,"./distanceToPoint":230,"./equals":231,"./fromPlanes":232,"./fromPointAndDirection":233,"./fromPoints":234,"./intersectPointOfLineAndPlane":236,"./origin":237,"./reverse":238,"./toString":239,"./transform":240}],236:[function(require,module,exports){
...
},{"../vec3":332}],237:[function(require,module,exports){
...
},{"../vec3":332,"./fromPointAndDirection":233}],239:[function(require,module,exports){
...
},{"../vec3":332,"./fromPointAndDirection":233}],241:[function(require,module,exports){
...
},{"./create":245}],243:[function(require,module,exports){
...
},{"./constants":243,"./identity":256}],248:[function(require,module,exports){
...
},{"./create":245}],252:[function(require,module,exports){
...
},{"../vec3":332,"./fromRotation":247}],253:[function(require,module,exports){
...
},{"../vec3/cross":324,"../vec3/dot":327,"../vec3/fromValues":330}],259:[function(require,module,exports){
...
},{"./copy":244}],262:[function(require,module,exports){
...
const vec3=require("../vec3"),fromNormalAndPoint=(e,o,r)=>{const t=vec3.unit(vec3.create(),o),c=vec3.dot(r,t);return e[0]=t[0],e[1]=t[1],e[2]=t[2],e[3]=c,e};module.exports=fromNormalAndPoint;

},{"../vec3":332}],271:[function(require,module,exports){
const vec3=require("../vec3"),fromPoints=(e,c,t,r)=>{const o=vec3.subtract(vec3.create(),t,c),s=vec3.subtract(vec3.create(),r,c);vec3.cross(o,o,s),vec3.unit(o,o);const v=vec3.dot(o,c);return e[0]=o[0],e[1]=o[1],e[2]=o[2],e[3]=v,e};module.exports=fromPoints;

},{"../vec3":332}],272:[function(require,module,exports){
const{EPS:EPS}=require("../constants"),vec3=require("../vec3"),fromPointsRandom=(e,c,t,o)=>{let r=vec3.subtract(vec3.create(),t,c),v=vec3.subtract(vec3.create(),o,c);vec3.length(r)<EPS&&(r=vec3.orthogonal(r,v)),vec3.length(v)<EPS&&(v=vec3.orthogonal(v,r));let n=vec3.cross(vec3.create(),r,v);vec3.length(n)<EPS&&(v=vec3.orthogonal(v,r),n=vec3.cross(n,r,v)),n=vec3.unit(n,n);const s=vec3.dot(n,c);return e[0]=n[0],e[1]=n[1],e[2]=n[2],e[3]=s,e};module.exports=fromPointsRandom;

},{"../constants":207,"../vec3":332}],273:[function(require,module,exports){
...
},{"../vec4/clone":352,"../vec4/copy":353,"../vec4/create":354,"../vec4/equals":356,"../vec4/fromValues":358,"../vec4/toString":360,"./flip":269,"./fromNormalAndPoint":270,"./fromPoints":271,"./fromPointsRandom":272,"./projectionOfPoint":274,"./signedDistanceToPoint":275,"./transform":276}],274:[function(require,module,exports){
...
},{"../mat4":257,"../vec3":332,"./flip":269,"./fromPoints":271}],277:[function(require,module,exports){
...
},{"./aboutEqualNormals":277,"./area":278,"./clamp":279,"./interpolateBetween2DPointsForY":281,"./intersect":282,"./solve2Linear":283}],281:[function(require,module,exports){
...
},{"./create":291}],290:[function(require,module,exports){
...
},{"./fromAngleRadians":298}],298:[function(require,module,exports){
...
},{"./create":291}],301:[function(require,module,exports){
...
},{"./abs":284,"./add":285,"./angle":286,"./angleDegrees":287,"./angleRadians":288,"./clone":289,"./copy":290,"./create":291,"./cross":292,"./distance":293,"./divide":294,"./dot":295,"./equals":296,"./fromAngleDegrees":297,"./fromAngleRadians":298,"./fromScalar":299,"./fromValues":300,"./length":302,"./lerp":303,"./max":304,"./min":305,"./multiply":306,"./negate":307,"./normal":308,"./normalize":309,"./rotate":310,"./scale":311,"./snap":312,"./squaredDistance":313,"./squaredLength":314,"./subtract":315,"./toString":316,"./transform":317}],302:[function(require,module,exports){
...
},{"./create":291,"./rotate":310}],309:[function(require,module,exports){
...
},{"./dot":327}],321:[function(require,module,exports){
const create=require("./create"),clone=e=>{const r=create();return r[0]=e[0],r[1]=e[1],r[2]=e[2],r};module.exports=clone;

},{"./create":323}],322:[function(require,module,exports){
const copy=(o,c)=>(o[0]=c[0],o[1]=c[1],o[2]=c[2],o);module.exports=copy;
...
},{"./abs":318,"./add":319,"./angle":320,"./clone":321,"./copy":322,"./create":323,"./cross":324,"./distance":325,"./divide":326,"./dot":327,"./equals":328,"./fromScalar":329,"./fromValues":330,"./fromVec2":331,"./length":333,"./lerp":334,"./max":335,"./min":336,"./multiply":337,"./negate":338,"./normalize":339,"./orthogonal":340,"./rotateX":341,"./rotateY":342,"./rotateZ":343,"./scale":344,"./snap":345,"./squaredDistance":346,"./squaredLength":347,"./subtract":348,"./toString":349,"./transform":350,"./unit":351}],333:[function(require,module,exports){
...
},{"./abs":318,"./create":323,"./cross":324}],341:[function(require,module,exports){
...
},{"./create":354}],353:[function(require,module,exports){
...
},{"./create":354}],359:[function(require,module,exports){
...
},{"./clone":352,"./copy":353,"./create":354,"./dot":355,"./equals":356,"./fromScalar":357,"./fromValues":358,"./toString":360,"./transform":361}],360:[function(require,module,exports){
...
},{"../maths/constants":207}],363:[function(require,module,exports){
...
},{"./measureAggregateArea":364,"./measureAggregateBoundingBox":365,"./measureAggregateEpsilon":366,"./measureAggregateVolume":367,"./measureArea":368,"./measureBoundingBox":369,"./measureEpsilon":370,"./measureVolume":371}],364:[function(require,module,exports){
...
},{"../utils/flatten":491,"./measureArea":368}],365:[function(require,module,exports){
...
},{"../maths/vec3/max":335,"../maths/vec3/min":336,"../utils/flatten":491,"./measureBoundingBox":369}],366:[function(require,module,exports){
...
},{"../geometries":164,"../utils/flatten":491,"./calculateEpsilonFromBounds":362,"./measureAggregateBoundingBox":365}],367:[function(require,module,exports){
...
},{"../utils/flatten":491,"./measureVolume":371}],368:[function(require,module,exports){
...
},{"../geometries":164,"../utils/flatten":491,"./calculateEpsilonFromBounds":362,"./measureBoundingBox":369}],371:[function(require,module,exports){
...
},{"../geometries/geom2":142,"../geometries/geom3":156,"../geometries/path2":177,"../geometries/poly3":193,"../utils/flatten":491}],372:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../maths/vec2":301}],373:[function(require,module,exports){
module.exports={intersect:require("./intersect"),subtract:require("./subtract"),union:require("./union")};

},{"./intersect":374,"./subtract":381,"./union":392}],374:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../utils/areAllShapesTheSameType":489,"../../utils/flatten":491,"./intersectGeom2":375,"./intersectGeom3":376}],375:[function(require,module,exports){
...
},{"../../geometries/geom3":156,"../../measurements/measureEpsilon":370,"../../utils/flatten":491,"./fromFakePolygons":372,"./intersectGeom3":376,"./to3DWalls":385}],376:[function(require,module,exports){
...
},{"../../utils/flatten":491,"./intersectGeom3Sub":377,"./retessellate":380}],377:[function(require,module,exports){
...
},{"../../geometries/geom3":156,"./mayOverlap":378,"./trees":389}],378:[function(require,module,exports){
...
},{"../../maths/constants":207,"../../measurements/measureBoundingBox":369}],379:[function(require,module,exports){
...
},{"../../geometries/poly3":193,"../../maths/OrthoNormalBasis":206,"../../maths/constants":207,"../../maths/line2":218,"../../maths/utils/interpolateBetween2DPointsForY":281,"../../maths/vec2":301,"../../utils":493}],380:[function(require,module,exports){
...
},{"../../geometries/geom3":156,"../../geometries/poly3":193,"./reTesselateCoplanarPolygons":379}],381:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../utils/areAllShapesTheSameType":489,"../../utils/flatten":491,"./subtractGeom2":382,"./subtractGeom3":383}],382:[function(require,module,exports){
...
},{"../../geometries/geom3":156,"../../measurements/measureEpsilon":370,"../../utils/flatten":491,"./fromFakePolygons":372,"./subtractGeom3":383,"./to3DWalls":385}],383:[function(require,module,exports){
...
},{"../../utils/flatten":491,"./retessellate":380,"./subtractGeom3Sub":384}],384:[function(require,module,exports){
...
},{"../../geometries/geom3":156,"./mayOverlap":378,"./trees":389}],385:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../geometries/poly3":193,"../../maths/vec3":332}],386:[function(require,module,exports){
...
},{"../../../geometries/poly3":193,"../../../maths/plane":273}],387:[function(require,module,exports){
...
},{"../../../geometries/poly3":193,"../../../maths/constants":207,"../../../maths/vec3":332,"./splitPolygonByPlane":391}],388:[function(require,module,exports){
...
},{"./Node":386,"./PolygonTreeNode":387}],389:[function(require,module,exports){
module.exports={Tree:require("./Tree")};

},{"./Tree":388}],390:[function(require,module,exports){
...
},{"../../../maths/vec3":332}],391:[function(require,module,exports){
...
},{"../../../geometries/poly3":193,"../../../maths/constants":207,"../../../maths/plane":273,"../../../maths/vec3":332,"./splitLineSegmentByPlane":390}],392:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../utils/areAllShapesTheSameType":489,"../../utils/flatten":491,"./unionGeom2":393,"./unionGeom3":394}],393:[function(require,module,exports){
...
},{"../../geometries/geom3":156,"../../measurements/measureEpsilon":370,"../../utils/flatten":491,"./fromFakePolygons":372,"./to3DWalls":385,"./unionGeom3":394}],394:[function(require,module,exports){
...
},{"../../utils/flatten":491,"./retessellate":380,"./unionGeom3Sub":395}],395:[function(require,module,exports){
...
},{"../../geometries/geom3":156,"./mayOverlap":378,"./trees":389}],396:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../geometries/path2":177,"../../utils/flatten":491,"./expandGeom2":397,"./expandGeom3":398,"./expandPath2":399}],397:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"./offsetFromPoints":404}],398:[function(require,module,exports){
...
},{"../../geometries/geom3":156,"../booleans/union":392,"./expandShell":400}],399:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/path2":177,"../../maths/utils/area":278,"../../maths/vec2":301,"./offsetFromPoints":404}],400:[function(require,module,exports){
const{EPS:EPS}=require("../../maths/constants"),mat4=require("../../maths/mat4"),vec3=require("../../maths/vec3"),fnNumberSort=require("../../utils/fnNumberSort"),geom3=require("../../geometries/geom3"),poly3=require("../../geometries/poly3"),sphere=require("../../primitives/sphere"),retessellate=require("../booleans/retessellate"),unionGeom3Sub=require("../booleans/unionGeom3Sub"),extrudePolygon=require("./extrudePolygon"),mapPlaneToVertex=(e,t,n)=>{const o=e.findIndex(e=>vec3.equals(e[0],t));if(o<0){const o=[t,[n]];return e.push(o),e.length}return e[o][1].push(n),o},mapPlaneToEdge=(e,t,n)=>{const o=e.findIndex(e=>vec3.equals(e[0],t[0])&&vec3.equals(e[1],t[1])||vec3.equals(e[0],t[1])&&vec3.equals(e[1],t[0]));if(o<0){const o=[t,[n]];return e.push(o),e.length}return e[o][1].push(n),o},addUniqueAngle=(e,t)=>{const n=e.findIndex(e=>e===t);return n<0?(e.push(t),e.length):n},expandShell=(e,t)=>{const{delta:n,segments:o}=Object.assign({},{delta:1,segments:12},e);let s=geom3.create();const r=[],c=[],a=vec3.create(),l=vec3.create();return geom3.toPolygons(t).forEach((e,t)=>{const o=vec3.scale(vec3.create(),poly3.plane(e),2*n),a=poly3.transform(mat4.fromTranslation(mat4.create(),vec3.scale(vec3.create(),o,-.5)),e),l=extrudePolygon(o,a);s=unionGeom3Sub(s,l);const u=e.vertices;for(let t=0;t<u.length;t++){mapPlaneToVertex(r,u[t],poly3.plane(e));const n=(t+1)%u.length,o=[u[t],u[n]];mapPlaneToEdge(c,o,poly3.plane(e))}}),c.forEach(e=>{const t=e[0],r=e[1],c=t[0],u=t[1],i=vec3.subtract(vec3.create(),u,c);vec3.unit(i,i);const h=r[0],v=vec3.cross(vec3.create(),h,i);let m=[];for(let e=0;e<o;e++)addUniqueAngle(m,e*Math.PI*2/o);for(let e=0,t=r.length;e<t;e++){const t=r[e],n=vec3.dot(v,t),o=vec3.dot(h,t);let s=Math.atan2(n,o);s<0&&(s+=2*Math.PI),addUniqueAngle(m,s),(s=Math.atan2(-n,-o))<0&&(s+=2*Math.PI),addUniqueAngle(m,s)}const d=(m=m.sort(fnNumberSort)).length;let p,g;const f=[],q=[],P=[];for(let e=-1;e<d;e++){const t=m[e<0?e+d:e],o=Math.sin(t),s=Math.cos(t);vec3.scale(a,h,s*n),vec3.scale(l,v,o*n),vec3.add(a,a,l);const r=vec3.add(vec3.create(),c,a),i=vec3.add(vec3.create(),u,a);let y=!1;if(e>=0&&vec3.distance(r,p)<EPS&&(y=!0),!y){if(e>=0){f.push(r),q.push(i);const e=[g,i,r,p],t=poly3.fromPoints(e);P.push(t)}p=r,g=i}}q.reverse(),P.push(poly3.fromPoints(f)),P.push(poly3.fromPoints(q));const y=geom3.create(P);s=unionGeom3Sub(s,y)}),r.forEach(e=>{const t=e[0],r=e[1],c=r[0];let u=null,i=0;for(let e=1;e<r.length;e++){const t=r[e],n=vec3.cross(a,c,t),o=vec3.length(n);o>.05&&o>i&&(i=o,u=t)}u||(u=vec3.orthogonal(a,c));const h=vec3.cross(a,c,u);vec3.unit(h,h);const v=vec3.cross(l,h,c),m=sphere({center:[t[0],t[1],t[2]],radius:n,segments:o,axes:[c,h,v]});s=unionGeom3Sub(s,m)}),retessellate(s)};module.exports=expandShell;

},{"../../geometries/geom3":156,"../../geometries/poly3":193,"../../maths/constants":207,"../../maths/mat4":257,"../../maths/vec3":332,"../../primitives/sphere":480,"../../utils/fnNumberSort":492,"../booleans/retessellate":380,"../booleans/unionGeom3Sub":395,"./extrudePolygon":401}],401:[function(require,module,exports){
...
},{"../../geometries/geom3":156,"../../geometries/poly3":193,"../../maths/mat4":257,"../../maths/vec3":332}],402:[function(require,module,exports){
module.exports={expand:require("./expand"),offset:require("./offset")};

},{"./expand":396,"./offset":403}],403:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/path2":177,"../../utils/flatten":491,"./offsetGeom2":405,"./offsetPath2":406}],404:[function(require,module,exports){
...
},{"../../maths/constants":207,"../../maths/line2":218,"../../maths/utils/area":278,"../../maths/utils/intersect":282,"../../maths/vec2":301}],405:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/poly2":187,"./offsetFromPoints":404}],406:[function(require,module,exports){
...
},{"../../geometries/path2":177,"./offsetFromPoints":404}],407:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../geometries/poly3":193,"../../maths/mat4":257,"./extrudeWalls":414,"./slice":423}],408:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../utils/flatten":491,"./extrudeLinearGeom2":409}],409:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../maths/mat4":257,"../../maths/vec3":332,"./extrudeFromSlices":407,"./slice":423}],410:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/path2":177,"../../utils/flatten":491,"./extrudeRectangularGeom2":411,"./extrudeRectangularPath2":412}],411:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/path2":177,"../../maths/utils":280,"../expansions/expand":396,"./extrudeLinearGeom2":409}],412:[function(require,module,exports){
...
},{"../../geometries/path2":177,"../expansions/expand":396,"./extrudeLinearGeom2":409}],413:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../maths/mat4":257,"../transforms/mirror":457,"./extrudeFromSlices":407,"./slice":423}],414:[function(require,module,exports){
...
},{"../../geometries/poly3":193,"../../maths/constants":207,"../../maths/vec3":332,"./slice":423}],415:[function(require,module,exports){
...
},{"./extrudeFromSlices":407,"./extrudeLinear":408,"./extrudeRectangular":410,"./extrudeRotate":413,"./project":416,"./slice":423}],416:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../geometries/poly3":193,"../../maths/mat4":257,"../../maths/plane":273,"../../maths/utils/aboutEqualNormals":277,"../../measurements/measureEpsilon":370,"../../utils/flatten":491,"../booleans/unionGeom2":393,"../booleans/unionGeom3":394}],417:[function(require,module,exports){
...
},{"../../../maths/plane":273,"../../../maths/vec3":332}],418:[function(require,module,exports){
...
},{"../../../maths/vec3":332,"./create":419}],419:[function(require,module,exports){
...
},{"../../../maths/vec3":332}],421:[function(require,module,exports){
...
},{"../../../maths/vec3":332,"./create":419}],422:[function(require,module,exports){
...
},{"../../../maths/vec3":332,"./create":419}],423:[function(require,module,exports){
...
},{"./calculatePlane":417,"./clone":418,"./create":419,"./equals":420,"./fromPoints":421,"./fromSides":422,"./isA":424,"./reverse":425,"./toEdges":426,"./toPolygons":427,"./toString":428,"./transform":429}],424:[function(require,module,exports){
...
},{"./create":419}],426:[function(require,module,exports){
...
},{"../../../geometries/geom3":156,"../../../geometries/poly3":193,"../../../maths/vec3":332,"../../booleans/intersectGeom3Sub":377,"./calculatePlane":417}],428:[function(require,module,exports){
...
},{"../../../maths/vec3":332}],429:[function(require,module,exports){
...
},{"../../../maths/vec3":332,"./create":419}],430:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../geometries/path2":177,"../../utils/areAllShapesTheSameType":489,"../../utils/flatten":491,"./hullGeom2":432,"./hullGeom3":433,"./hullPath2":434}],431:[function(require,module,exports){
...
},{"../../utils/flatten":491,"../booleans/union":392,"./hull":430}],432:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../utils/flatten":491,"./hullPoints2":435}],433:[function(require,module,exports){
...
},{"../../geometries/geom3":156,"../../geometries/poly3":193,"../../utils/flatten":491,"./quickhull":443}],434:[function(require,module,exports){
...
},{"../../geometries/path2":177,"../../maths/vec2":301,"../../utils/flatten":491,"./hullPoints2":435}],435:[function(require,module,exports){
...
},{"../../maths/vec2":301}],436:[function(require,module,exports){
module.exports={hull:require("./hull"),hullChain:require("./hullChain")};

},{"./hull":430,"./hullChain":431}],437:[function(require,module,exports){
...
},{"../../../maths/vec3/add":319,"../../../maths/vec3/copy":322,"../../../maths/vec3/cross":324,"../../../maths/vec3/dot":327,"../../../maths/vec3/length":333,"../../../maths/vec3/normalize":339,"../../../maths/vec3/scale":344,"../../../maths/vec3/subtract":348,"./HalfEdge":438}],438:[function(require,module,exports){
...
},{"../../../maths/vec3/distance":325,"../../../maths/vec3/squaredDistance":346}],439:[function(require,module,exports){
...
},{"../../../maths/vec3/dot":327,"./Face":437,"./Vertex":440,"./VertexList":441,"./get-plane-normal":442,"./point-line-distance":444}],440:[function(require,module,exports){
...
},{"../../../maths/vec3/cross":324,"../../../maths/vec3/normalize":339,"../../../maths/vec3/subtract":348}],443:[function(require,module,exports){
...
},{"./QuickHull":439}],444:[function(require,module,exports){
...
},{"../../../maths/vec3/cross":324,"../../../maths/vec3/squaredLength":347,"../../../maths/vec3/subtract":348}],445:[function(require,module,exports){
...
},{"../../geometries/poly3":193,"../../maths/line3":235,"../../maths/vec3":332}],446:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../geometries/path2":177,"../../measurements/measureEpsilon":370,"../../utils/flatten":491,"./insertTjunctions":448,"./mergePolygons":449,"./repairTjunctions":450,"./snapPolygons":452,"./triangulatePolygons":453}],447:[function(require,module,exports){
module.exports={generalize:require("./generalize"),snap:require("./snap")};

},{"./generalize":446,"./snap":451}],448:[function(require,module,exports){
...
},{"../../geometries/poly3":193,"../../maths/constants":207,"../../maths/vec3":332}],449:[function(require,module,exports){
...
},{"../../geometries/poly3":193,"../../maths/vec3":332}],450:[function(require,module,exports){
...
},{"./edges":445}],451:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../geometries/path2":177,"../../maths/vec2":301,"../../measurements/measureEpsilon":370,"../../utils/flatten":491,"./snapPolygons":452}],452:[function(require,module,exports){
const vec3=require("../../maths/vec3"),poly3=require("../../geometries/poly3"),isValidPoly3=(e,t)=>{const r=poly3.measureArea(t);return Number.isFinite(r)&&r>e},snapPolygons=(e,t)=>{let r=t.map(t=>{const r=t.vertices.map(t=>vec3.snap(vec3.create(),t,e)),s=[];for(let e=0;e<r.length;e++){const t=(e+1)%r.length;vec3.equals(r[e],r[t])||s.push(r[e])}return poly3.create(s)});const s=e*e*Math.sqrt(3)/4;return r=r.filter(e=>isValidPoly3(s,e))};module.exports=snapPolygons;

},{"../../geometries/poly3":193,"../../maths/vec3":332}],453:[function(require,module,exports){
const vec3=require("../../maths/vec3"),poly3=require("../../geometries/poly3"),triangulatePolygon=(e,t,r)=>{const o=t.vertices.length;if(o>3){if(o>4){const s=[0,0,0];t.vertices.forEach(e=>vec3.add(s,s,e)),vec3.snap(s,vec3.divide(s,s,[o,o,o]),e);for(let e=0;e<o;e++)r.push(poly3.fromPoints([s,t.vertices[e],t.vertices[(e+1)%o]]));return}return r.push(poly3.fromPoints([t.vertices[0],t.vertices[1],t.vertices[2]])),void r.push(poly3.fromPoints([t.vertices[0],t.vertices[2],t.vertices[3]]))}r.push(t)},triangulatePolygons=(e,t)=>{const r=[];return t.forEach(t=>{triangulatePolygon(e,t,r)}),r};module.exports=triangulatePolygons;

},{"../../geometries/poly3":193,"../../maths/vec3":332}],454:[function(require,module,exports){
...
},{"../../measurements/measureAggregateBoundingBox":365,"../../utils/flatten":491,"../../utils/padArrayToLength":495,"./translate":461}],455:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../geometries/path2":177,"../../measurements/measureBoundingBox":369,"../../utils/flatten":491,"./translate":461}],456:[function(require,module,exports){
...
},{"./align":454,"./center":455,"./mirror":457,"./rotate":458,"./scale":459,"./transform":460,"./translate":461}],457:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../geometries/path2":177,"../../maths/mat4":257,"../../maths/plane":273,"../../utils/flatten":491}],458:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../geometries/path2":177,"../../maths/mat4":257,"../../utils/flatten":491}],459:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../geometries/path2":177,"../../maths/mat4":257,"../../utils/flatten":491}],460:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../geometries/path2":177,"../../utils/flatten":491}],461:[function(require,module,exports){
...
},{"../../geometries/geom2":142,"../../geometries/geom3":156,"../../geometries/path2":177,"../../maths/mat4":257,"../../utils/flatten":491}],462:[function(require,module,exports){
...
},{"../geometries/path2":177,"../maths/constants":207,"../maths/vec2":301,"./commonChecks":464}],463:[function(require,module,exports){
...
},{"./commonChecks":464,"./ellipse":469}],464:[function(require,module,exports){
...
},{"./commonChecks":464,"./cuboid":466}],466:[function(require,module,exports){
...
},{"../geometries/geom3":156,"../geometries/poly3":193,"./commonChecks":464}],467:[function(require,module,exports){
...
},{"./commonChecks":464,"./cylinderElliptic":468}],468:[function(require,module,exports){
...
},{"../geometries/geom3":156,"../geometries/poly3":193,"../maths/constants":207,"../maths/vec3":332,"./commonChecks":464}],469:[function(require,module,exports){
...
},{"../geometries/geom2":142,"../maths/constants":207,"../maths/vec2":301,"./commonChecks":464}],470:[function(require,module,exports){
const vec3=require("../maths/vec3"),geom3=require("../geometries/geom3"),poly3=require("../geometries/poly3"),{isGTE:isGTE,isNumberArray:isNumberArray}=require("./commonChecks"),ellipsoid=e=>{const{center:c,radius:a,segments:r,axes:s}=Object.assign({},{center:[0,0,0],radius:[1,1,1],segments:32,axes:[[1,0,0],[0,-1,0],[0,0,1]]},e);if(!isNumberArray(c,3))throw new Error("center must be an array of X, Y and Z values");if(!isNumberArray(a,3))throw new Error("radius must be an array of X, Y and Z values");if(!a.every(e=>e>0))throw new Error("radius values must be greater than zero");if(!isGTE(r,4))throw new Error("segments must be four or more");const t=vec3.scale(vec3.create(),vec3.unit(vec3.create(),s[0]),a[0]),v=vec3.scale(vec3.create(),vec3.unit(vec3.create(),s[1]),a[1]),o=vec3.scale(vec3.create(),vec3.unit(vec3.create(),s[2]),a[2]),u=Math.round(r/4);let l;const d=[],i=vec3.create(),n=vec3.create();for(let e=0;e<=r;e++){const a=2*Math.PI*e/r,s=vec3.add(vec3.create(),vec3.scale(i,t,Math.cos(a)),vec3.scale(n,v,Math.sin(a)));if(e>0){let e,a;for(let r=0;r<=u;r++){const t=.5*Math.PI*r/u,v=Math.cos(t),h=Math.sin(t);if(r>0){let t,m=[];t=vec3.subtract(vec3.create(),vec3.scale(i,l,e),vec3.scale(n,o,a)),m.push(vec3.add(t,t,c)),t=vec3.subtract(vec3.create(),vec3.scale(i,s,e),vec3.scale(n,o,a)),m.push(vec3.add(t,t,c)),r<u&&(t=vec3.subtract(vec3.create(),vec3.scale(i,s,v),vec3.scale(n,o,h)),m.push(vec3.add(t,t,c))),t=vec3.subtract(vec3.create(),vec3.scale(i,l,v),vec3.scale(n,o,h)),m.push(vec3.add(t,t,c)),d.push(poly3.fromPoints(m)),m=[],t=vec3.add(vec3.create(),vec3.scale(i,l,e),vec3.scale(n,o,a)),m.push(vec3.add(vec3.create(),c,t)),t=vec3.add(t,vec3.scale(i,s,e),vec3.scale(n,o,a)),m.push(vec3.add(vec3.create(),c,t)),r<u&&(t=vec3.add(t,vec3.scale(i,s,v),vec3.scale(n,o,h)),m.push(vec3.add(vec3.create(),c,t))),t=vec3.add(t,vec3.scale(i,l,v),vec3.scale(n,o,h)),m.push(vec3.add(vec3.create(),c,t)),m.reverse(),d.push(poly3.fromPoints(m))}e=v,a=h}}l=s}return geom3.create(d)};module.exports=ellipsoid;

},{"../geometries/geom3":156,"../geometries/poly3":193,"../maths/vec3":332,"./commonChecks":464}],471:[function(require,module,exports){
...
},{"../geometries/geom3":156,"../maths/mat4":257,"./commonChecks":464,"./polyhedron":475}],472:[function(require,module,exports){
...
},{"./arc":462,"./circle":463,"./cube":465,"./cuboid":466,"./cylinder":467,"./cylinderElliptic":468,"./ellipse":469,"./ellipsoid":470,"./geodesicSphere":471,"./line":473,"./polygon":474,"./polyhedron":475,"./rectangle":476,"./roundedCuboid":477,"./roundedCylinder":478,"./roundedRectangle":479,"./sphere":480,"./square":481,"./star":482,"./torus":483}],473:[function(require,module,exports){
...
},{"../geometries/path2":177}],474:[function(require,module,exports){
...
},{"../geometries/geom2":142}],475:[function(require,module,exports){
...
},{"../geometries/geom3":156,"../geometries/poly3":193,"./commonChecks":464}],476:[function(require,module,exports){
...
},{"../geometries/geom2":142,"../maths/vec2":301,"./commonChecks":464}],477:[function(require,module,exports){
...
},{"../geometries/geom3":156,"../geometries/poly3":193,"../maths/constants":207,"../maths/vec2":301,"../maths/vec3":332,"./commonChecks":464}],478:[function(require,module,exports){
const{EPS:EPS}=require("../maths/constants"),vec3=require("../maths/vec3"),geom3=require("../geometries/geom3"),poly3=require("../geometries/poly3"),{isGT:isGT,isGTE:isGTE,isNumberArray:isNumberArray}=require("./commonChecks"),roundedCylinder=e=>{const{center:c,height:r,radius:a,roundRadius:s,segments:t}=Object.assign({},{center:[0,0,0],height:2,radius:1,roundRadius:.2,segments:32},e);if(!isNumberArray(c,3))throw new Error("center must be an array of X, Y and Z values");if(!isGT(r,0))throw new Error("height must be greater then zero");if(!isGT(a,0))throw new Error("radius must be greater then zero");if(!isGT(s,0))throw new Error("roundRadius must be greater then zero");if(s>a-EPS)throw new Error("roundRadius must be smaller then the radius");if(!isGTE(t,4))throw new Error("segments must be four or more");const v=[0,0,-r/2],u=[0,0,r/2],o=vec3.subtract(vec3.create(),u,v);if(2*s>vec3.length(o)-EPS)throw new Error("height must be larger than twice roundRadius");let d;d=Math.abs(o[0])>Math.abs(o[1])?vec3.fromValues(0,1,0):vec3.fromValues(1,0,0);const i=vec3.scale(vec3.create(),vec3.unit(vec3.create(),o),s),n=vec3.scale(vec3.create(),vec3.unit(vec3.create(),vec3.cross(vec3.create(),i,d)),a),h=vec3.scale(vec3.create(),vec3.unit(vec3.create(),vec3.cross(vec3.create(),n,i)),a);vec3.add(v,v,i),vec3.subtract(u,u,i);const l=Math.floor(.25*t),m=e=>{const r=e.map(e=>vec3.add(e,e,c));return poly3.fromPoints(r)},p=[],b=vec3.create(),g=vec3.create();let f;for(let e=0;e<=t;e++){const c=2*Math.PI*e/t,r=vec3.add(vec3.create(),vec3.scale(b,n,Math.cos(c)),vec3.scale(g,h,Math.sin(c)));if(e>0){let e,c,a=[];a.push(vec3.add(vec3.create(),v,r)),a.push(vec3.add(vec3.create(),v,f)),a.push(vec3.add(vec3.create(),u,f)),a.push(vec3.add(vec3.create(),u,r)),p.push(m(a));for(let s=0;s<=l;s++){const t=.5*Math.PI*s/l,o=Math.cos(t),d=Math.sin(t);if(s>0){let t;a=[],t=vec3.add(vec3.create(),v,vec3.subtract(b,vec3.scale(b,f,e),vec3.scale(g,i,c))),a.push(t),t=vec3.add(vec3.create(),v,vec3.subtract(b,vec3.scale(b,r,e),vec3.scale(g,i,c))),a.push(t),s<l&&(t=vec3.add(vec3.create(),v,vec3.subtract(b,vec3.scale(b,r,o),vec3.scale(g,i,d))),a.push(t)),t=vec3.add(vec3.create(),v,vec3.subtract(b,vec3.scale(b,f,o),vec3.scale(g,i,d))),a.push(t),p.push(m(a)),a=[],t=vec3.add(vec3.create(),vec3.scale(b,f,e),vec3.scale(g,i,c)),vec3.add(t,t,u),a.push(t),t=vec3.add(vec3.create(),vec3.scale(b,r,e),vec3.scale(g,i,c)),vec3.add(t,t,u),a.push(t),s<l&&(t=vec3.add(vec3.create(),vec3.scale(b,r,o),vec3.scale(g,i,d)),vec3.add(t,t,u),a.push(t)),t=vec3.add(vec3.create(),vec3.scale(b,f,o),vec3.scale(g,i,d)),vec3.add(t,t,u),a.push(t),a.reverse(),p.push(m(a))}e=o,c=d}}f=r}return geom3.create(p)};module.exports=roundedCylinder;

},{"../geometries/geom3":156,"../geometries/poly3":193,"../maths/constants":207,"../maths/vec3":332,"./commonChecks":464}],479:[function(require,module,exports){
...
},{"../geometries/geom2":142,"../maths/constants":207,"../maths/vec2":301,"./commonChecks":464}],480:[function(require,module,exports){
...
},{"./commonChecks":464,"./ellipsoid":470}],481:[function(require,module,exports){
...
},{"./commonChecks":464,"./rectangle":476}],482:[function(require,module,exports){
...
},{"../geometries/geom2":142,"../maths/vec2":301,"./commonChecks":464}],483:[function(require,module,exports){
...
},{"../operations/extrusions/extrudeRotate":413,"../operations/transforms/rotate":458,"../operations/transforms/translate":461,"./circle":463,"./commonChecks":464}],484:[function(require,module,exports){
...
},{"./vectorChar":486,"./vectorText":488}],486:[function(require,module,exports){
...
},{"./vectorParams":487}],487:[function(require,module,exports){
...
},{"./fonts/single-line/hershey/simplex.js":484}],488:[function(require,module,exports){
...
},{"./vectorChar":486,"./vectorParams":487}],489:[function(require,module,exports){
...
},{"../geometries/geom2":142,"../geometries/geom3":156,"../geometries/path2":177}],490:[function(require,module,exports){
...
},{"./areAllShapesTheSameType":489,"./degToRad":490,"./flatten":491,"./fnNumberSort":492,"./insertSorted":494,"./radToDeg":496,"./radiusToSegments":497}],494:[function(require,module,exports){
...
},{"./flatten":498,"./fnNumberSort":499,"./head":500,"./insertSorted":502,"./nth":503,"./padToLength":504,"./toArray":505}],502:[function(require,module,exports){
...
},{"./cacheWithInvalidation":507,"./generators/geometry-generator-cached-csg":508,"@jscad/array-utils":501}],507:[function(require,module,exports){
...
},{"object-hash":554}],508:[function(require,module,exports){
...
},{"@jscad/array-utils":501,"@jscad/modeling":205}],509:[function(require,module,exports){
const{flatten:flatten}=require("@jscad/array-utils"),color=(r,...t)=>({children:t=flatten(t),type:"color",params:r});module.exports=color;

},{"@jscad/array-utils":501}],510:[function(require,module,exports){
...
},{"./color":509,"./operations/booleans":511,"./operations/expansions":516,"./operations/extrusions":522,"./operations/hulls":525,"./operations/measurements":526,"./operations/measurements/measureArea":527,"./operations/measurements/measureBounds":528,"./operations/measurements/measureVolume":529,"./operations/transforms":531,"./primitives":543,"@jscad/modeling":205}],511:[function(require,module,exports){
module.exports={intersect:require("./intersect"),subtract:require("./subtract"),union:require("./union")};

},{"./intersect":512,"./subtract":513,"./union":514}],512:[function(require,module,exports){
...
},{"@jscad/array-utils":501}],513:[function(require,module,exports){
...
},{"@jscad/array-utils":501}],514:[function(require,module,exports){
...
},{"@jscad/array-utils":501}],515:[function(require,module,exports){
...
},{"@jscad/array-utils":501}],516:[function(require,module,exports){
module.exports={expand:require("./expand"),offset:require("./offset")};

},{"./expand":515,"./offset":517}],517:[function(require,module,exports){
...
},{"@jscad/array-utils":501}],518:[function(require,module,exports){
...
},{"@jscad/array-utils":501}],519:[function(require,module,exports){
...
},{"@jscad/array-utils":501}],520:[function(require,module,exports){
...
},{"@jscad/array-utils":501}],521:[function(require,module,exports){
...
},{"@jscad/array-utils":501}],522:[function(require,module,exports){
...
},{"./extrudeFromSlices":518,"./extrudeLinear":519,"./extrudeRectangular":520,"./extrudeRotate":521}],523:[function(require,module,exports){
const{flatten:flatten}=require("@jscad/array-utils"),hull=(...l)=>({children:l=flatten(l),type:"hull",params:void 0});module.exports=hull;

},{"@jscad/array-utils":501}],524:[function(require,module,exports){
...
},{"@jscad/array-utils":501}],525:[function(require,module,exports){
module.exports={hull:require("./hull"),hullChain:require("./hullChain")};

},{"./hull":523,"./hullChain":524}],526:[function(require,module,exports){
module.exports={measureArea:require("./measureArea"),measureBounds:require("./measureBounds"),measureVolume:require("./measureVolume")};

},{"./measureArea":527,"./measureBounds":528,"./measureVolume":529}],527:[function(require,module,exports){
...
},{"../../../cacheWithInvalidation":507,"../../../generators/geometry-generator-cached-csg":508,"@jscad/array-utils":501,"@jscad/modeling":205}],528:[function(require,module,exports){
...
},{"../../../cacheWithInvalidation":507,"../../../generators/geometry-generator-cached-csg":508,"@jscad/modeling":205}],529:[function(require,module,exports){
...
},{"../../../cacheWithInvalidation":507,"../../../generators/geometry-generator-cached-csg":508,"@jscad/array-utils":501,"@jscad/modeling":205}],530:[function(require,module,exports){
...
},{"@jscad/array-utils":501}],531:[function(require,module,exports){
module.exports={center:require("./center").center,centerX:require("./center").centerX,centerY:require("./center").centerY,centerZ:require("./center").centerZ,mirror:require("./mirror").mirror,mirrorX:require("./mirror").mirrorX,mirrorY:require("./mirror").mirrorY,mirrorZ:require("./mirror").mirrorZ,rotate:require("./rotate").rotate,rotateX:require("./rotate").rotateX,rotateY:require("./rotate").rotateY,rotateZ:require("./rotate").rotateZ,scale:require("./scale").scale,scaleX:require("./scale").scaleX,scaleY:require("./scale").scaleY,scaleZ:require("./scale").scaleZ,transform:require("./transform"),translate:require("./translate").translate,translateX:require("./translate").translateX,translateY:require("./translate").translateY,translateZ:require("./translate").translateZ};

},{"./center":530,"./mirror":532,"./rotate":533,"./scale":534,"./transform":535,"./translate":536}],532:[function(require,module,exports){
...
},{"@jscad/array-utils":501}],533:[function(require,module,exports){
...
},{"@jscad/array-utils":501}],536:[function(require,module,exports){
...
},{"@jscad/array-utils":501}],537:[function(require,module,exports){
...
},{"./arc":537,"./cuboid":538,"./cylinderElliptic":539,"./ellipse":540,"./ellipsoid":541,"./geodesicSphere":542,"./line":544,"./polygon":545,"./polyhedron":546,"./rectangle":547,"./roundedCuboid":548,"./roundedCylinder":549,"./roundedRectangle":550,"./star":551,"./torus":552}],544:[function(require,module,exports){
...
},{"./core/buildCachedGeometryFromTree":506,"./core/modeling":510}],554:[function(require,module,exports){
(function (global){(function (){
