/*! @jscad/x3d-deserializer V3.0.5-alpha.0 (MIT) */
...
/**
  	 ...
  	 */
Object.defineProperty(exports$1,"__esModule",{value:!0}),exports$1.CHAR="\t\n\r -퟿-�𐀀-􏿿",exports$1.S=" \t\r\n",exports$1.NAME_START_CHAR=":A-Z_a-zÀ-ÖØ-öø-˿Ͱ-ͽͿ-῿‌‍⁰-↏Ⰰ-⿯、-퟿豈-﷏ﷰ-�𐀀-󯿿",exports$1.NAME_CHAR="-"+exports$1.NAME_START_CHAR+".0-9·̀-ͯ‿-⁀",exports$1.CHAR_RE=new RegExp("^["+exports$1.CHAR+"]$","u"),exports$1.S_RE=new RegExp("^["+exports$1.S+"]+$","u"),exports$1.NAME_START_CHAR_RE=new RegExp("^["+exports$1.NAME_START_CHAR+"]$","u"),exports$1.NAME_CHAR_RE=new RegExp("^["+exports$1.NAME_CHAR+"]$","u"),exports$1.NAME_RE=new RegExp("^["+exports$1.NAME_START_CHAR+"]["+exports$1.NAME_CHAR+"]*$","u"),exports$1.NMTOKEN_RE=new RegExp("^["+exports$1.NAME_CHAR+"]+$","u"),exports$1.S_LIST=[32,10,13,9],exports$1.isChar=function(c){return c>=32&&c<=55295||10===c||13===c||9===c||c>=57344&&c<=65533||c>=65536&&c<=1114111},exports$1.isS=function(c){return 32===c||10===c||13===c||9===c},exports$1.isNameStartChar=isNameStartChar,exports$1.isNameChar=function(c){return isNameStartChar(c)||c>=48&&c<=57||45===c||46===c||183===c||c>=768&&c<=879||c>=8255&&c<=8256}}(ed5$1);var ed2$1={};!function(exports$1){function isNameStartChar(c){return c>=65&&c<=90||c>=97&&c<=122||58===c||95===c||8204===c||8205===c||c>=192&&c<=214||c>=216&&c<=246||c>=248&&c<=767||c>=880&&c<=893||c>=895&&c<=8191||c>=8304&&c<=8591||c>=11264&&c<=12271||c>=12289&&c<=55295||c>=63744&&c<=64975||c>=65008&&c<=65533||c>=65536&&c<=983039}
/**
  	 ...
  	 * @copyright Louis-Dominique Dubeau
  	 */
Object.defineProperty(exports$1,"__esModule",{value:!0}),exports$1.CHAR="-퟿-�𐀀-􏿿",exports$1.RESTRICTED_CHAR="-\b\v\f---",exports$1.S=" \t\r\n",exports$1.NAME_START_CHAR=":A-Z_a-zÀ-ÖØ-öø-˿Ͱ-ͽͿ-῿‌‍⁰-↏Ⰰ-⿯、-퟿豈-﷏ﷰ-�𐀀-󯿿",exports$1.NAME_CHAR="-"+exports$1.NAME_START_CHAR+".0-9·̀-ͯ‿-⁀",exports$1.CHAR_RE=new RegExp("^["+exports$1.CHAR+"]$","u"),exports$1.RESTRICTED_CHAR_RE=new RegExp("^["+exports$1.RESTRICTED_CHAR+"]$","u"),exports$1.S_RE=new RegExp("^["+exports$1.S+"]+$","u"),exports$1.NAME_START_CHAR_RE=new RegExp("^["+exports$1.NAME_START_CHAR+"]$","u"),exports$1.NAME_CHAR_RE=new RegExp("^["+exports$1.NAME_CHAR+"]$","u"),exports$1.NAME_RE=new RegExp("^["+exports$1.NAME_START_CHAR+"]["+exports$1.NAME_CHAR+"]*$","u"),exports$1.NMTOKEN_RE=new RegExp("^["+exports$1.NAME_CHAR+"]+$","u"),exports$1.S_LIST=[32,10,13,9],exports$1.isChar=function(c){return c>=1&&c<=55295||c>=57344&&c<=65533||c>=65536&&c<=1114111},exports$1.isRestrictedChar=function(c){return c>=1&&c<=8||11===c||12===c||c>=14&&c<=31||c>=127&&c<=132||c>=134&&c<=159},exports$1.isCharAndNotRestricted=function(c){return 9===c||10===c||13===c||c>31&&c<127||133===c||c>159&&c<=55295||c>=57344&&c<=65533||c>=65536&&c<=1114111},exports$1.isS=function(c){return 32===c||10===c||13===c||9===c},exports$1.isNameStartChar=isNameStartChar,exports$1.isNameChar=function(c){return isNameStartChar(c)||c>=48&&c<=57||45===c||46===c||183===c||c>=768&&c<=879||c>=8255&&c<=8256}}(ed2$1);var ed3={};!function(exports$1){function isNCNameStartChar(c){return c>=65&&c<=90||95===c||c>=97&&c<=122||c>=192&&c<=214||c>=216&&c<=246||c>=248&&c<=767||c>=880&&c<=893||c>=895&&c<=8191||c>=8204&&c<=8205||c>=8304&&c<=8591||c>=11264&&c<=12271||c>=12289&&c<=55295||c>=63744&&c<=64975||c>=65008&&c<=65533||c>=65536&&c<=983039}
/**
