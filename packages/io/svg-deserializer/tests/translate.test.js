...
test('deserialize : translate svg (rect) to script', function (t) {
  ...
  t.is(typeof obs, 'string')
  // FIXME t.is(countOf('path2.fromPoints', obs), 2)
})
...
test('deserialize : translate svg (path: simple) to script', function (t) {
  ...
  <path stroke-width="2" d="M150 0 L75 200 L225 200 Z" />
</svg>`
  ...
  sourceSvg = `<svg width="120" height="120" viewBox="0 0 120 120"">
  <path d="m 240.00000 190.00000 h 30.00000 v 30.00000 h 30.00000 v 30.00000 h 30.00000 v 30.00000 h -90.00000 v -90.00000 z"/>
</svg>`
...
test.skip('deserialize : translate shape with a hole to script', function (t) {
  const sourceSvg = `
...
test.skip('deserialize : translate shape with a nested hole to script', function (t) {
