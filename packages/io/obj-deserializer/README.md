...
> Deserializer for OBJ data to CSG geometries
...
This deserializer converts raw OBJ formatted data (files) to JSCAD scripts or CSG geometries.
...
| OBJ Command     | CSG Geometry | Notes |
| --------------- | ------------ | ------ |
...
const geometries = objDeserializer.deserialize(rawData, 'file.obj', {output: 'csg'})
