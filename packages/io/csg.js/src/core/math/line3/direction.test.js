...
test('line3: direction() should return proper direction', (t) => {
  ...
  t.true(compareVectors(dir2, [-0.7071067690849304, 0.7071067690849304, 0]))

  const line3 = fromPoints([0, 1, 0], [1, 0, 0])
  const dir3 = direction(line3)
  t.true(compareVectors(dir3, [0.7071067690849304, -0.7071067690849304, 0]))
  ...
  t.true(compareVectors(dir5, [0.5773502588272095, 0.5773502588272095, 0.5773502588272095]))
})
