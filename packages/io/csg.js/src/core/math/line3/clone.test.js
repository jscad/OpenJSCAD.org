...
test('line3: clone() should return a new line3 with same values', (t) => {
  ...
  t.true(compareVectors(obs2[1], [0.7071067690849304, 0, 0.7071067690849304]))
  t.not(obs2, org2)

  const org3 = fromPointAndDirection([-1, -2, -3], [0, -1, -1])
  const obs3 = clone(org3)
  t.true(compareVectors(obs3[0], [-1, -2, -3]))
  t.true(compareVectors(obs3[1], [0, -0.7071067690849304, -0.7071067690849304]))
  t.not(obs3, org3)
})
...
test('line3: clone() with two params should update a line3 with same values', (t) => {
  ...
  t.true(compareVectors(line2[1], [0.7071067690849304, 0, 0.7071067690849304]))
  t.true(compareVectors(ret2[0], [1, 2, 3]))
  t.true(compareVectors(ret2[1], [0.7071067690849304, 0, 0.7071067690849304]))
  t.not(ret2, org2)
  ...
  t.true(compareVectors(line3[1], [0, -0.7071067690849304, -0.7071067690849304]))
  t.true(compareVectors(ret3[0], [-1, -2, -3]))
  t.true(compareVectors(ret3[1], [0, -0.7071067690849304, -0.7071067690849304]))
  t.not(ret3, org3)
})
