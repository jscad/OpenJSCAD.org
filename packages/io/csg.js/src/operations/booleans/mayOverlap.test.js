...
test.only('mayOverlap: determination of overlap is reliable', t => {
  ...
  geometry2 = cuboid({ size: [1, 1, 1], center: [3, 3, 3] })
  t.true(mayOverlap(geometry1, geometry2))
  geometry2 = cuboid({ size: [1, 1, 1], center: [-3, 3, 3] })
  t.true(mayOverlap(geometry1, geometry2))
  geometry2 = cuboid({ size: [1, 1, 1], center: [-3, -3, 3] })
  ...
  let issue1 = cuboid({ size: [22, 13, 2.5], center: [0, 0, -1] })
  let issue2 = cuboid({ size: [22, 13, 0.9], center: [5, 0, -4.400001] })
  t.true(mayOverlap(issue1, issue2))

  geometry2 = cuboid({ size: [2, 2, 2], center: [0, 0, 4 + 0.000001] })
  t.true(mayOverlap(geometry1, geometry2))
  geometry2 = cuboid({ size: [2, 2, 2], center: [0, 0, -4 - 0.000001] })
  t.true(mayOverlap(geometry1, geometry2))
  geometry2 = cuboid({ size: [2, 2, 2], center: [0, 4 + 0.000001, 0] })
  t.true(mayOverlap(geometry1, geometry2))
  geometry2 = cuboid({ size: [2, 2, 2], center: [0, -4 - 0.000001, 0] })
  t.true(mayOverlap(geometry1, geometry2))
  geometry2 = cuboid({ size: [2, 2, 2], center: [4 + 0.000001, 0, 0] })
  t.true(mayOverlap(geometry1, geometry2))
  geometry2 = cuboid({ size: [2, 2, 2], center: [-4 - 0.000001, 0, 0] })
  t.true(mayOverlap(geometry1, geometry2))
  ...
  geometry2 = cuboid({ size: [2, 2, 2], center: [0, 0, 4 + EPS] })
  t.false(mayOverlap(geometry1, geometry2))
  geometry2 = cuboid({ size: [2, 2, 2], center: [0, 0, -4 - EPS] })
  t.false(mayOverlap(geometry1, geometry2))
  geometry2 = cuboid({ size: [2, 2, 2], center: [0, 4 + EPS, 0] })
  t.false(mayOverlap(geometry1, geometry2))
  geometry2 = cuboid({ size: [2, 2, 2], center: [0, -4 - EPS, 0] })
  t.false(mayOverlap(geometry1, geometry2))
  geometry2 = cuboid({ size: [2, 2, 2], center: [4 + EPS, 0, 0] })
  t.false(mayOverlap(geometry1, geometry2))
  geometry2 = cuboid({ size: [2, 2, 2], center: [-4 - EPS, 0, 0] })
  t.false(mayOverlap(geometry1, geometry2))
})
