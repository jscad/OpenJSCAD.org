...
test('line2: direction() should return proper direction', (t) => {
  ...
  t.true(compareVectors(dir2, [-0.7071067690849304, 0.7071067690849304]))

  const line3 = fromPoints([0, 1], [1, 0])
  const dir3 = direction(line3)
  t.true(compareVectors(dir3, [0.7071067690849304, -0.7071067690849304]))

  const line4 = fromPoints([0, 0], [6, 0])
  const dir4 = direction(line4)
  t.true(compareVectors(dir4, [1, 0]))

  const line5 = fromPoints([-5, 5], [5, -5])
  const dir5 = direction(line5)
  t.true(compareVectors(dir5, [0.7071067690849304, -0.7071067690849304]))
})
