...
test('poly3: measureSignedVolume() should return correct values', (t) => {
  ...
  nearlyEqual(t, ret1, 0.0, Number.EPSILON)
  nearlyEqual(t, ret2, 83.33333329074473, Number.EPSILON)
  ...
  ret3 = measureSignedVolume(ply3)
  ret4 = measureSignedVolume(ply4)
  nearlyEqual(t, ret2, -83.33333335462764, Number.EPSILON)
  nearlyEqual(t, ret3, -166.66666664537237, Number.EPSILON)
  nearlyEqual(t, ret4, 324.9999030160325, Number.EPSILON)
