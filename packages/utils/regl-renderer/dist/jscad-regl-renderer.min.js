...
},{"./lib/projectMat4":2}],2:[function(require,module,exports){
...
},{"./adjoint":3,"./clone":4,"./copy":5,"./create":6,"./determinant":7,"./fromQuat":8,"./fromRotation":9,"./fromRotationTranslation":10,"./fromScaling":11,"./fromTranslation":12,"./fromXRotation":13,"./fromYRotation":14,"./fromZRotation":15,"./frustum":16,"./identity":17,"./invert":19,"./lookAt":20,"./multiply":21,"./ortho":22,"./perspective":23,"./perspectiveFromFieldOfView":24,"./rotate":25,"./rotateX":26,"./rotateY":27,"./rotateZ":28,"./scale":29,"./str":30,"./translate":31,"./transpose":32}],19:[function(require,module,exports){
...
},{"./identity":17}],21:[function(require,module,exports){
...
},{"./dot":44,"./fromValues":50,"./normalize":61}],35:[function(require,module,exports){
...
},{"./epsilon":45}],47:[function(require,module,exports){
...
},{"./create":38}],50:[function(require,module,exports){
...
},{"./add":33,"./angle":34,"./ceil":35,"./clone":36,"./copy":37,"./create":38,"./cross":39,"./dist":40,"./distance":41,"./div":42,"./divide":43,"./dot":44,"./epsilon":45,"./equals":46,"./exactEquals":47,"./floor":48,"./forEach":49,"./fromValues":50,"./inverse":52,"./len":53,"./length":54,"./lerp":55,"./max":56,"./min":57,"./mul":58,"./multiply":59,"./negate":60,"./normalize":61,"./random":62,"./rotateX":63,"./rotateY":64,"./rotateZ":65,"./round":66,"./scale":67,"./scaleAndAdd":68,"./set":69,"./sqrDist":70,"./sqrLen":71,"./squaredDistance":72,"./squaredLength":73,"./sub":74,"./subtract":75,"./transformMat3":76,"./transformMat4":77,"./transformQuat":78}],52:[function(require,module,exports){
function inverse(e,n){return e[0]=1/n[0],e[1]=1/n[1],e[2]=1/n[2],e}module.exports=inverse;

},{}],53:[function(require,module,exports){
module.exports=require("./length");

},{"./length":54}],54:[function(require,module,exports){
...
},{"./multiply":59}],59:[function(require,module,exports){
...
},{"./squaredDistance":72}],71:[function(require,module,exports){
module.exports=require("./squaredLength");

},{"./squaredLength":73}],72:[function(require,module,exports){
...
},{"./subtract":75}],75:[function(require,module,exports){
...
},{"./flatten":80,"./fnNumberSort":81,"./head":82,"./insertSorted":84,"./nth":85,"./padToLength":86,"./toArray":87}],84:[function(require,module,exports){
...
},{"./boundingBox":88,"@jscad/array-utils":83,"gl-vec3":51}],90:[function(require,module,exports){
...
},{"./orthographicCamera":91,"./perspectiveCamera":92,"gl-mat4":18,"gl-vec3":51}],91:[function(require,module,exports){
...
},{"gl-mat4":18}],92:[function(require,module,exports){
...
},{"gl-mat4":18,"gl-vec3":51}],93:[function(require,module,exports){
...
},{"../bound-utils/computeBounds":89,"../cameras/orthographicCamera":91,"camera-unproject":1,"gl-mat4":18,"gl-vec3":51}],94:[function(require,module,exports){
...
},{"../rendering/renderDefaults":111,"./geom2ToGeometries":95,"./geom3ToGeometries":96,"./path2ToGeometries":97,"@jscad/array-utils":83}],95:[function(require,module,exports){
...
},{"gl-mat4":18}],96:[function(require,module,exports){
...
},{"gl-mat4":18,"gl-vec3":51}],97:[function(require,module,exports){
...
},{"gl-mat4":18}],98:[function(require,module,exports){
...
},{"gl-mat4":18}],100:[function(require,module,exports){
...
},{"gl-mat4":18}],101:[function(require,module,exports){
...
},{"../../renderDefaults":111,"./colorOnlyShaders":102,"./meshShaders":104,"./vColorShaders":105,"gl-mat4":18}],104:[function(require,module,exports){
...
},{"../../renderDefaults":111,"./meshShaders":107,"./vColorShaders":108,"gl-mat4":18}],107:[function(require,module,exports){
const meshFrag="\nprecision mediump float;\nvarying vec3 surfaceNormal;\nuniform float ambientLightAmount;\nuniform float diffuseLightAmount;\nuniform vec4 ucolor;\nuniform vec3 lightDirection;\nuniform vec3 opacity;\n\nvarying vec4 _worldSpacePosition;\n\nuniform vec2 printableArea;\n\nvec4 errorColor = vec4(0.15, 0.15, 0.15, 0.3);\n\nvoid main () {\n  vec4 depth = gl_FragCoord;\n\n  float v = 0.8; // shadow value\n  vec4 endColor = ucolor;\n\n  vec3 ambient = ambientLightAmount * endColor.rgb;\n  float cosTheta = dot(surfaceNormal, lightDirection);\n  vec3 diffuse = diffuseLightAmount * endColor.rgb * clamp(cosTheta , 0.0, 1.0 );\n\n  float cosTheta2 = dot(surfaceNormal, vec3(-lightDirection.x, -lightDirection.y, lightDirection.z));\n  vec3 diffuse2 = diffuseLightAmount * endColor.rgb * clamp(cosTheta2 , 0.0, 1.0 );\n\n  gl_FragColor = vec4((ambient + diffuse + diffuse2 * v), endColor.a);\n}",meshVert="\nprecision mediump float;\n\nuniform float camNear, camFar;\nuniform mat4 model, view, projection;\n\nattribute vec3 position, normal;\n\nvarying vec3 surfaceNormal, surfacePosition;\nvarying vec4 _worldSpacePosition;\n\nvoid main() {\n  surfacePosition = position;\n  surfaceNormal = normal;\n  vec4 worldSpacePosition = model * vec4(position, 1);\n  _worldSpacePosition = worldSpacePosition;\n\n  vec4 glPosition = projection * view * model * vec4(position, 1);\n  gl_Position = glPosition;\n}\n";module.exports={vert:meshVert,frag:meshFrag};
...
},{"./renderContext":110,"./renderDefaults":111,"regl":79}],110:[function(require,module,exports){
...
},{"gl-mat4":18}],111:[function(require,module,exports){
