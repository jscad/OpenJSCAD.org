...
const { measureBoundingBox, create, transform } = require('./index')
...
test('poly2: measureBoundingBox() should return correct values', (t) => {
  ...
  t.true(compareVectors(ret1[0], exp1[0]))
  t.true(compareVectors(ret1[1], exp1[1]))
  exp2 = [[-7.071067811865475, 0], [7.0710678118654755, 7.0710678118654755]]
  t.true(compareVectors(ret2[0], exp2[0]))
  t.true(compareVectors(ret2[1], exp2[1]))
  exp3 = [[-7.071067811865475, 0], [7.0710678118654755, 14.142135623730951]]
  t.true(compareVectors(ret3[0], exp3[0]))
  t.true(compareVectors(ret3[1], exp3[1]))
  exp4 = [[-2.121320343559642, 2.1213203435596424], [4.242640687119286, 9.899494936611665]]
  t.true(compareVectors(ret4[0], exp4[0]))
  t.true(compareVectors(ret4[1], exp4[1]))
})
