...
test('extrudeRotate: (angle) extruding of a geom2 produces an expected geom3', (t) => {
  ...
  const exp = [
    ...
    [
      ...
      [7.071067811865478, 7.071067811865474, -8], 
      [7.071067811865476, 7.071067811865475, 8],
      [18.38477631085024, 18.384776310850235, 8], 
    ],
...
test('extrudeRotate: (overlap +/-) extruding of a geom2 produces an expected geom3', (t) => {
  ...
  exp = [
    ...
    [[-4.2862637970157346e-16, 0.9999999999999998, 8],
     [-1.2246467991473475e-16, 2.0000000000000004, 3.9999999999999964], 
     [5.510910596163092e-16, 1.0000000000000004, -8],
     [ 4.898587196589414e-16, 0, -8],
     [-4.898587196589412e-16, 0, 8]
    ],
    [
     [1.0000000000000004, 4.898587196589411e-16, 8],
     [0, 4.898587196589411e-16, 8],
     [0, -4.898587196589413e-16, -8.000000000000002], 
     [1.0000000000000027, -4.898587196589413e-16, -8.000000000000002],
     [2.000000000000001, 2.449293598294702e-16, 3.9999999999999964], 
    ]
  ]
  t.is(pts.length, 14)
  t.true(comparePolygonsAsPoints(pts, exp))
