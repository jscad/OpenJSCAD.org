...
test('extrudeRotate: (angle) extruding of a geom2 produces an expected geom3', (t) => {
  ...
  const exp = [
    ...
    [[18.38477631085024, 18.384776310850235, -8], [7.0710678118654755, 7.071067811865475, -8], [7.0710678118654755, 7.071067811865475, 8]],
    [[7.0710678118654755, 7.071067811865475, 8], [18.38477631085024, 18.384776310850235, 8], [18.38477631085024, 18.384776310850235, -8]],
    [[10, 0, 8], [10, 0, -8], [26, 0, -8]],
    [[26, 0, -8], [26, 0, 8], [10, 0, 8]]
  ]
  t.notThrows(() => geom3.validate(geometry3))
  t.is(pts.length, 12)
