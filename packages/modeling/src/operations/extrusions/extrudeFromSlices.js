 ...
 * @param {Boolean} [options.startCapped=true] the solid should have a cap at the start
 * @param {Boolean} [options.endCapped=true] the solid should have a cap at the end
...
const extrudeFromSlices = (options, base) => {
  ...
  const { numberOfSlices, startCapped, endCapped, callback: generate } = Object.assign({ }, defaults, options)
