...
test('extrudeFromSlices (holes)', (t) => {
  ...
  const exp = [
    ...
    [[-5, 5, 0], [5, 5, 0], [5, 5, 1]],
    [[-5, 5, 0], [5, 5, 1], [-5, 5, 1]],
    [[-5, 10, 1], [-10, 10, 1], [-10, -10, 1], [-5, -10, 1]],
    [[10, -5, 1], [-5, -5, 1], [-5, -10, 1], [10, -10, 1]],
    [[5, -5, 1], [10, -5, 1], [10, 10, 1], [5, 10, 1]],
    [[5, 5, 1], [5, 10, 1], [-5, 10, 1], [-5, 5, 1]],
    [[-5, 10, 0], [-5, -10, 0], [-10, -10, 0], [-10, 10, 0]],
    [[-5, -5, 0], [10, -5, 0], [10, -10, 0], [-5, -10, 0]],
    [[5, -5, 0], [5, 10, 0], [10, 10, 0], [10, -5, 0]],
    [[5, 5, 0], [-5, 5, 0], [-5, 10, 0], [5, 10, 0]]
  ]
  t.is(pts.length, 24)
  t.true(comparePolygonsAsPoints(pts, exp))
})
