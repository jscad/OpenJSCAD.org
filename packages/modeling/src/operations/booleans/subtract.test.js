...
test('subtract: subtract of one or more geom3 objects produces expected geometry', t => {
  ...
  exp = [
    ...
    [ [ 8, 9, 8 ], [ 8, 9, 12 ], [ 8, 12, 12 ], [ 8, 12, 8 ] ],
    [ [ 8, 9, 9 ], [ 8, 8, 9 ], [ 8, 8, 12 ], [ 8, 9, 12 ] ],
    [ [ 9, 8, 8 ], [ 12, 8, 8 ], [ 12, 8, 12 ], [ 9, 8, 12 ] ],
    [ [ 8, 8, 9 ], [ 9, 8, 9 ], [ 9, 8, 12 ], [ 8, 8, 12 ] ],
    [ [ 8, 9, 8 ], [ 8, 12, 8 ], [ 12, 12, 8 ], [ 12, 9, 8 ] ],
    [ [ 9, 8, 8 ], [ 9, 9, 8 ], [ 12, 9, 8 ], [ 12, 8, 8 ] ]
  ]
  t.is(obs.length, 12)
  t.true(comparePolygonsAsPoints(obs, exp))
