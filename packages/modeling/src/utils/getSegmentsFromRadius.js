 ...
 * @parma {Number} minimumLength - minimum length of segments; 0 > length
 * @parma {Number} minimumAngle - minimum angle (radians) between segments; 0 > angle < Math.PI * 2
 * @returns {Number} number of segments to complete the radius
 * @alias module:modeling/utils.getSegmentsFromRadius
 */
const getSegmentsFromRadius = (radius, minimumLength, minimumAngle) => {
...
module.exports = getSegmentsFromRadius
