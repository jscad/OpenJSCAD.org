...
test('calculate arcLengthToT for an 1D linear bezier with numeric control points', (t) => {
  ...
  const len = length(bezierCurve)
  nearlyEqual(t, arcLengthToT(0, bezierCurve), 0, 0.0001)
  nearlyEqual(t, arcLengthToT(len / 2, bezierCurve), 0.5, 0.0001)
  nearlyEqual(t, arcLengthToT(len, bezierCurve), 1, 0.0001)
  t.true(true)
})
...
test('calculate arcLengthToT for a 2D quadratic (3 control points) bezier', (t) => {
  ...
  const len = length(bezierCurve)
  nearlyEqual(t, arcLengthToT(0, bezierCurve), 0, 0.0001)
  nearlyEqual(t, arcLengthToT(len / 2, bezierCurve), 0.50001, 0.0001)
  nearlyEqual(t, arcLengthToT(len, bezierCurve), 1, 0.0001)
  t.true(true)
})
...
test('calculate arcLengthToT for a 2D cubic (4 control points) bezier', (t) => {
  ...
  const len = length(bezierCurve)
  nearlyEqual(t, arcLengthToT(0, bezierCurve), 0, 0.0001)
  nearlyEqual(t, arcLengthToT(len / 2, bezierCurve), 0.49999, 0.0001)
  nearlyEqual(t, arcLengthToT(len, bezierCurve), 1, 0.0001)
  t.true(true)
})
...
test('calculate arcLengthToT for a 3D cubic (4 control points) bezier', (t) => {
  ...
  const len = length(bezierCurve)
  nearlyEqual(t, arcLengthToT(0, bezierCurve), 0, 0.0001)
  nearlyEqual(t, arcLengthToT(len / 2, bezierCurve), 0.5621, 0.0001)
  nearlyEqual(t, arcLengthToT(len, bezierCurve), 1, 0.0001)
  t.true(true)
})