...
August 2011
Adapted for OpenJSCAD.org by Rene K. Mueller, March 2013
*/
...
function test_geo_chord_factors() {
...
function test_geo_struts(radius = 1) {
	// Get struts for 2v
